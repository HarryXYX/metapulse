...
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/common/InstitutionalMemory.pdl.")
    ...
    extends WrappingArrayTemplate<InstitutionalMemoryMetadata>
{
    ...
    public static InstitutionalMemoryMetadataArray.ProjectionMask createMask() {
        return new InstitutionalMemoryMetadataArray.ProjectionMask();
    }
    ...
    @Override
    protected InstitutionalMemoryMetadata coerceOutput(Object object)
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.common.InstitutionalMemoryMetadata.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public InstitutionalMemoryMetadataArray.ProjectionMask withItems(Function<com.linkedin.common.InstitutionalMemoryMetadata.ProjectionMask, com.linkedin.common.InstitutionalMemoryMetadata.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?InstitutionalMemoryMetadata.createMask():_itemsMask));
