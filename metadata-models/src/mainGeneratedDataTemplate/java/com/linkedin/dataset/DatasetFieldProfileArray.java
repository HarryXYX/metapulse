    ...
    extends WrappingArrayTemplate<DatasetFieldProfile>
{
    ...
    public static DatasetFieldProfileArray.ProjectionMask createMask() {
        return new DatasetFieldProfileArray.ProjectionMask();
    }
    ...
    @Override
    protected DatasetFieldProfile coerceOutput(Object object)
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.dataset.DatasetFieldProfile.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public DatasetFieldProfileArray.ProjectionMask withItems(Function<com.linkedin.dataset.DatasetFieldProfile.ProjectionMask, com.linkedin.dataset.DatasetFieldProfile.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?DatasetFieldProfile.createMask():_itemsMask));
