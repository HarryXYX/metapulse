    ...
    extends WrappingArrayTemplate<Criterion>
{
    ...
    public static CriterionArray.ProjectionMask createMask() {
        return new CriterionArray.ProjectionMask();
    }
    ...
    {
        CriterionArray __clone = ((CriterionArray) super.clone());
        return __clone;
    }
    ...
    public CriterionArray copy()
        throws CloneNotSupportedException
    {
        CriterionArray __copy = ((CriterionArray) super.copy());
        return __copy;
    }

    @Override
    protected Criterion coerceOutput(Object object)
        throws TemplateOutputCastException
    {
        assert(object != null);
        return ((object == null)?null:new Criterion(DataTemplateUtil.castOrThrow(object, DataMap.class)));
    }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.query.filter.Criterion.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public CriterionArray.ProjectionMask withItems(Function<com.linkedin.metadata.query.filter.Criterion.ProjectionMask, com.linkedin.metadata.query.filter.Criterion.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?Criterion.createMask():_itemsMask));
