 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/metadata/snapshot/MLPrimaryKeySnapshot.pdl.")
public class MLPrimaryKeySnapshot
    extends RecordTemplate
{

    private final static MLPrimaryKeySnapshot.Fields _fields = new MLPrimaryKeySnapshot.Fields();
    ...
    private MLPrimaryKeySnapshot.ChangeListener __changeListener = new MLPrimaryKeySnapshot.ChangeListener(this);
    ...
    public static MLPrimaryKeySnapshot.Fields fields() {
        return _fields;
    }

    public static MLPrimaryKeySnapshot.ProjectionMask createMask() {
        return new MLPrimaryKeySnapshot.ProjectionMask();
    }
     ...
     * 
     * @see MLPrimaryKeySnapshot.Fields#urn
     */
     ...
     * @see MLPrimaryKeySnapshot.Fields#urn
     */
    public MLPrimaryKeySnapshot setUrn(
        @Nullable
     ...
     * 
     * @see MLPrimaryKeySnapshot.Fields#aspects
     */
        ...
        switch (mode) {
            ...
            case NULL:
                if (_aspectsField!= null) {
                    ...
                    _aspectsField = ((__rawValue == null)?null:new MLPrimaryKeyAspectArray(DataTemplateUtil.castOrThrow(__rawValue, DataList.class)));
                    return _aspectsField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
     ...
     * @see MLPrimaryKeySnapshot.Fields#aspects
     */
    public MLPrimaryKeySnapshot setAspects(
        @Nullable
        MLPrimaryKeyAspectArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
    ...
    @Override
    public MLPrimaryKeySnapshot clone()
        throws CloneNotSupportedException
    {
        MLPrimaryKeySnapshot __clone = ((MLPrimaryKeySnapshot) super.clone());
        __clone.__changeListener = new MLPrimaryKeySnapshot.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public MLPrimaryKeySnapshot copy()
        throws CloneNotSupportedException
    {
        MLPrimaryKeySnapshot __copy = ((MLPrimaryKeySnapshot) super.copy());
        __copy._urnField = null;
        __copy._aspectsField = null;
        __copy.__changeListener = new MLPrimaryKeySnapshot.ChangeListener(__copy);
        ...
        extends PathSpec
    {
         ...
         * 
         */
        public com.linkedin.metadata.aspect.MLPrimaryKeyAspectArray.Fields aspects() {
            return new com.linkedin.metadata.aspect.MLPrimaryKeyAspectArray.Fields(getPathComponents(), "aspects");
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.MLPrimaryKeyAspectArray.ProjectionMask _aspectsMask;
         ...
         * 
         */
        public MLPrimaryKeySnapshot.ProjectionMask withUrn() {
         ...
         * 
         */
        public MLPrimaryKeySnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.MLPrimaryKeyAspectArray.ProjectionMask, com.linkedin.metadata.aspect.MLPrimaryKeyAspectArray.ProjectionMask> nestedMask) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?MLPrimaryKeyAspectArray.createMask():_aspectsMask));
         ...
         * 
         */
        public MLPrimaryKeySnapshot.ProjectionMask withAspects() {
            _aspectsMask = null;
         ...
         * 
         */
        public MLPrimaryKeySnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.MLPrimaryKeyAspectArray.ProjectionMask, com.linkedin.metadata.aspect.MLPrimaryKeyAspectArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?MLPrimaryKeyAspectArray.createMask():_aspectsMask));
            getDataMap().put("aspects", _aspectsMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public MLPrimaryKeySnapshot.ProjectionMask withAspects(Integer start, Integer count) {
            _aspectsMask = null;
