 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/metadata/snapshot/MLModelSnapshot.pdl.")
    ...
    extends RecordTemplate
{
    ...
    private com.linkedin.common.urn.MLModelUrn _urnField = null;
    private MLModelAspectArray _aspectsField = null;
    private MLModelSnapshot.ChangeListener __changeListener = new MLModelSnapshot.ChangeListener(this);
    ...
    public static MLModelSnapshot.ProjectionMask createMask() {
        return new MLModelSnapshot.ProjectionMask();
    }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_urnField!= null) {
                    ...
                    _urnField = DataTemplateUtil.coerceCustomOutput(__rawValue, com.linkedin.common.urn.MLModelUrn.class);
                    return _urnField;
                }
        }
    ...
    public MLModelSnapshot setUrn(
        @Nullable
        com.linkedin.common.urn.MLModelUrn value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setUrn(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field urn of com.linkedin.metadata.snapshot.MLModelSnapshot");
                } else {
                    CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.MLModelUrn.class));
                    _urnField = value;
                }
                break;
            case REMOVE_IF_NULL:
    ...
    public MLModelSnapshot setUrn(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field urn of com.linkedin.metadata.snapshot.MLModelSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.MLModelUrn.class));
            _urnField = value;
        }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_aspectsField!= null) {
                    ...
                    _aspectsField = ((__rawValue == null)?null:new MLModelAspectArray(DataTemplateUtil.castOrThrow(__rawValue, DataList.class)));
                    return _aspectsField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
    ...
    public MLModelSnapshot setAspects(
        @Nullable
        MLModelAspectArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setAspects(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field aspects of com.linkedin.metadata.snapshot.MLModelSnapshot");
                } else {
    ...
    public MLModelSnapshot setAspects(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field aspects of com.linkedin.metadata.snapshot.MLModelSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "aspects", value.data());
            _aspectsField = value;
        }
    ...
    {
        MLModelSnapshot __clone = ((MLModelSnapshot) super.clone());
        __clone.__changeListener = new MLModelSnapshot.ChangeListener(__clone);
    ...
    public MLModelSnapshot copy()
        throws CloneNotSupportedException
    {
        MLModelSnapshot __copy = ((MLModelSnapshot) super.copy());
        __copy._urnField = null;
        __copy._aspectsField = null;
        __copy.__changeListener = new MLModelSnapshot.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final MLModelSnapshot __objectRef;

        private ChangeListener(MLModelSnapshot reference) {
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.MLModelAspectArray.ProjectionMask _aspectsMask;
         ...
         * 
         */
        public MLModelSnapshot.ProjectionMask withUrn() {
         ...
         * 
         */
        public MLModelSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.MLModelAspectArray.ProjectionMask, com.linkedin.metadata.aspect.MLModelAspectArray.ProjectionMask> nestedMask) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?MLModelAspectArray.createMask():_aspectsMask));
         ...
         * 
         */
        public MLModelSnapshot.ProjectionMask withAspects() {
            _aspectsMask = null;
         ...
         * 
         */
        public MLModelSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.MLModelAspectArray.ProjectionMask, com.linkedin.metadata.aspect.MLModelAspectArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?MLModelAspectArray.createMask():_aspectsMask));
            getDataMap().put("aspects", _aspectsMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public MLModelSnapshot.ProjectionMask withAspects(Integer start, Integer count) {
            _aspectsMask = null;
