...
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/metadata/aspect/MLModelGroupAspect.pdl.")
    ...
    implements HasTyperefInfo
{
    ...
    private com.linkedin.metadata.key.MLModelGroupKey _mLModelGroupKeyMember = null;
    private com.linkedin.ml.metadata.MLModelGroupProperties _mLModelGroupPropertiesMember = null;
    ...
    private MLModelGroupAspect.ChangeListener __changeListener = new MLModelGroupAspect.ChangeListener(this);
    ...
    public final static String MEMBERKEY_MLModelGroupKey = "com.linkedin.metadata.key.MLModelGroupKey";
    ...
    public final static String MEMBERKEY_MLModelGroupProperties = "com.linkedin.ml.metadata.MLModelGroupProperties";
    ...
    public com.linkedin.metadata.key.MLModelGroupKey getMLModelGroupKey() {
        checkNotNull();
        if (_mLModelGroupKeyMember!= null) {
            return _mLModelGroupKeyMember;
        }
        Object __rawValue = super._map.get("com.linkedin.metadata.key.MLModelGroupKey");
        _mLModelGroupKeyMember = ((__rawValue == null)?null:new com.linkedin.metadata.key.MLModelGroupKey(DataTemplateUtil.castOrThrow(__rawValue, DataMap.class)));
        return _mLModelGroupKeyMember;
    }
    ...
    public void setMLModelGroupKey(com.linkedin.metadata.key.MLModelGroupKey value) {
        checkNotNull();
        super._map.clear();
        _mLModelGroupKeyMember = value;
        CheckedUtil.putWithoutChecking(super._map, "com.linkedin.metadata.key.MLModelGroupKey", value.data());
    }
    ...
    public com.linkedin.ml.metadata.MLModelGroupProperties getMLModelGroupProperties() {
        checkNotNull();
        if (_mLModelGroupPropertiesMember!= null) {
            return _mLModelGroupPropertiesMember;
        }
        Object __rawValue = super._map.get("com.linkedin.ml.metadata.MLModelGroupProperties");
        _mLModelGroupPropertiesMember = ((__rawValue == null)?null:new com.linkedin.ml.metadata.MLModelGroupProperties(DataTemplateUtil.castOrThrow(__rawValue, DataMap.class)));
        return _mLModelGroupPropertiesMember;
    }
    ...
    public void setMLModelGroupProperties(com.linkedin.ml.metadata.MLModelGroupProperties value) {
        checkNotNull();
        super._map.clear();
        _mLModelGroupPropertiesMember = value;
        CheckedUtil.putWithoutChecking(super._map, "com.linkedin.ml.metadata.MLModelGroupProperties", value.data());
    }
    ...
    public static MLModelGroupAspect create(com.linkedin.common.BrowsePathsV2 value) {
        MLModelGroupAspect newUnion = new MLModelGroupAspect();
    ...
    public static MLModelGroupAspect.ProjectionMask createMask() {
        return new MLModelGroupAspect.ProjectionMask();
    }
    ...
    {
        MLModelGroupAspect __clone = ((MLModelGroupAspect) super.clone());
        __clone.__changeListener = new MLModelGroupAspect.ChangeListener(__clone);
    ...
    public MLModelGroupAspect copy()
        throws CloneNotSupportedException
    {
        MLModelGroupAspect __copy = ((MLModelGroupAspect) super.copy());
        __copy._mLModelGroupKeyMember = null;
        ...
        __copy._mLModelGroupPropertiesMember = null;
        __copy._statusMember = null;
        __copy.__changeListener = new MLModelGroupAspect.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final MLModelGroupAspect __objectRef;

        private ChangeListener(MLModelGroupAspect reference) {
        ...
        public void onUnderlyingMapChanged(String key, Object value) {
            switch (key) {
                case "com.linkedin.metadata.key.MLModelGroupKey":
                    __objectRef._mLModelGroupKeyMember = null;
                    break;
                ...
                case "com.linkedin.common.Ownership":
                    ...
                    break;
                case "com.linkedin.ml.metadata.MLModelGroupProperties":
                    __objectRef._mLModelGroupPropertiesMember = null;
                    break;
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.key.MLModelGroupKey.ProjectionMask _MLModelGroupKeyMask;
        private com.linkedin.ml.metadata.MLModelGroupProperties.ProjectionMask _MLModelGroupPropertiesMask;
        ...
        public MLModelGroupAspect.ProjectionMask withMLModelGroupKey(Function<com.linkedin.metadata.key.MLModelGroupKey.ProjectionMask, com.linkedin.metadata.key.MLModelGroupKey.ProjectionMask> nestedMask) {
            _MLModelGroupKeyMask = nestedMask.apply(((_MLModelGroupKeyMask == null)?com.linkedin.metadata.key.MLModelGroupKey.createMask():_MLModelGroupKeyMask));
            getDataMap().put("com.linkedin.metadata.key.MLModelGroupKey", _MLModelGroupKeyMask.getDataMap());
            return this;
        }

        public MLModelGroupAspect.ProjectionMask withMLModelGroupProperties(Function<com.linkedin.ml.metadata.MLModelGroupProperties.ProjectionMask, com.linkedin.ml.metadata.MLModelGroupProperties.ProjectionMask> nestedMask) {
            _MLModelGroupPropertiesMask = nestedMask.apply(((_MLModelGroupPropertiesMask == null)?com.linkedin.ml.metadata.MLModelGroupProperties.createMask():_MLModelGroupPropertiesMask));
            getDataMap().put("com.linkedin.ml.metadata.MLModelGroupProperties", _MLModelGroupPropertiesMask.getDataMap());
            return this;
        }

        public MLModelGroupAspect.ProjectionMask withOwnership(Function<com.linkedin.common.Ownership.ProjectionMask, com.linkedin.common.Ownership.ProjectionMask> nestedMask) {
        ...
        public MLModelGroupAspect.ProjectionMask withStatus(Function<com.linkedin.common.Status.ProjectionMask, com.linkedin.common.Status.ProjectionMask> nestedMask) {
        ...
        public MLModelGroupAspect.ProjectionMask withDeprecation(Function<com.linkedin.common.Deprecation.ProjectionMask, com.linkedin.common.Deprecation.ProjectionMask> nestedMask) {
        ...
        public MLModelGroupAspect.ProjectionMask withBrowsePaths(Function<com.linkedin.common.BrowsePaths.ProjectionMask, com.linkedin.common.BrowsePaths.ProjectionMask> nestedMask) {
        ...
        public MLModelGroupAspect.ProjectionMask withGlobalTags(Function<com.linkedin.common.GlobalTags.ProjectionMask, com.linkedin.common.GlobalTags.ProjectionMask> nestedMask) {
        ...
        public MLModelGroupAspect.ProjectionMask withDataPlatformInstance(Function<com.linkedin.common.DataPlatformInstance.ProjectionMask, com.linkedin.common.DataPlatformInstance.ProjectionMask> nestedMask) {
        ...
        public MLModelGroupAspect.ProjectionMask withBrowsePathsV2(Function<com.linkedin.common.BrowsePathsV2.ProjectionMask, com.linkedin.common.BrowsePathsV2.ProjectionMask> nestedMask) {
