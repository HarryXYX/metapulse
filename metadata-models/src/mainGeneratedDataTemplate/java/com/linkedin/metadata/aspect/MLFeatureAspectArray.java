    ...
    extends WrappingArrayTemplate<MLFeatureAspect>
{
    ...
    public static MLFeatureAspectArray.ProjectionMask createMask() {
        return new MLFeatureAspectArray.ProjectionMask();
    }

    @Override
    public MLFeatureAspectArray clone()
        throws CloneNotSupportedException
    {
        MLFeatureAspectArray __clone = ((MLFeatureAspectArray) super.clone());
        return __clone;
    }

    @Override
    public MLFeatureAspectArray copy()
        throws CloneNotSupportedException
    {
        MLFeatureAspectArray __copy = ((MLFeatureAspectArray) super.copy());
        return __copy;
    }

    @Override
    protected MLFeatureAspect coerceOutput(Object object)
        throws TemplateOutputCastException
    {
        assert(object != null);
        return ((object == null)?null:new MLFeatureAspect(object));
    }
        ...
        extends PathSpec
    {
        ...
        public com.linkedin.metadata.aspect.MLFeatureAspect.Fields items() {
            return new com.linkedin.metadata.aspect.MLFeatureAspect.Fields(getPathComponents(), PathSpec.WILDCARD);
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.MLFeatureAspect.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public MLFeatureAspectArray.ProjectionMask withItems(Function<com.linkedin.metadata.aspect.MLFeatureAspect.ProjectionMask, com.linkedin.metadata.aspect.MLFeatureAspect.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?MLFeatureAspect.createMask():_itemsMask));
