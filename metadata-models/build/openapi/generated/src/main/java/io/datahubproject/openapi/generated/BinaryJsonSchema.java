...
public class BinaryJsonSchema  implements OneOfSchemaMetadataPlatformSchema {
  ...
  @JsonProperty(value = "__type", defaultValue = "BinaryJsonSchema") @Builder.Default
   ...
   * @return __type
   **/
  @Schema(required = true, description = "Name of this subclass in SimpleClassName format", allowableValues = {"BinaryJsonSchema"},
  defaultValue = "BinaryJsonSchema")
  @NotNull
  ...
  public BinaryJsonSchema schema(String schema) {
    this.schema = schema;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BinaryJsonSchema binaryJsonSchema = (BinaryJsonSchema) o;
    return Objects.equals(this.schema, binaryJsonSchema.schema);
  }
