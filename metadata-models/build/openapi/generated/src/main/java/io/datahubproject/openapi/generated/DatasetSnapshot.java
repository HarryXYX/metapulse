...
public class DatasetSnapshot  implements OneOfEntityValue {
  ...
  @JsonProperty(value = "__type", defaultValue = "DatasetSnapshot") @Builder.Default
  private String __type = "DatasetSnapshot";

  /**
   * Name of this subclass in SimpleClassName format
   * @return __type
   **/
  @Schema(required = true, description = "Name of this subclass in SimpleClassName format", allowableValues = {"DatasetSnapshot"},
  defaultValue = "DatasetSnapshot")
  @NotNull
  ...
  @Valid
  private List<OneOfDatasetSnapshotAspectsItems> aspects = new ArrayList<>();

  public DatasetSnapshot urn(String urn) {
    this.urn = urn;
    return this;
  }
  ...
  public DatasetSnapshot aspects(List<OneOfDatasetSnapshotAspectsItems> aspects) {
    this.aspects = aspects;
    return this;
  }

  public DatasetSnapshot addAspectsItem(OneOfDatasetSnapshotAspectsItems aspectsItem) {
  ...
  public void setAspects(List<OneOfDatasetSnapshotAspectsItems> aspects) {
    this.aspects = aspects;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DatasetSnapshot datasetSnapshot = (DatasetSnapshot) o;
    return Objects.equals(this.urn, datasetSnapshot.urn) &&
        Objects.equals(this.aspects, datasetSnapshot.aspects);
  }
