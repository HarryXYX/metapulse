...
public class VersionInfo  implements OneOfEnvelopedAspectValue, OneOfGenericAspectValue {
  ...
  @JsonProperty(value = "__type", defaultValue = "VersionInfo") @Builder.Default
   ...
   * @return __type
   **/
  @Schema(required = true, description = "Name of this subclass in SimpleClassName format", allowableValues = {"VersionInfo"},
  ...
  @JsonProperty("versionType") @Builder.Default
  private String versionType = null;

  public VersionInfo customProperties(Map<String, String> customProperties) {
    this.customProperties = customProperties;
    return this;
  }

  public VersionInfo putCustomPropertiesItem(String key, String customPropertiesItem) {
  ...
  public VersionInfo externalUrl(String externalUrl) {
  ...
  public VersionInfo versionType(String versionType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.customProperties, versionInfo.customProperties) &&
        Objects.equals(this.externalUrl, versionInfo.externalUrl) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customProperties, externalUrl, version, versionType);
  }
