...
public class QuantitativeAnalyses  implements OneOfMLModelSnapshotAspectsItems, OneOfVersionedAspectAspect {

  @Getter(value = lombok.AccessLevel.NONE)
  @JsonProperty(value = "__type", defaultValue = "QuantitativeAnalyses") @Builder.Default
  private String __type = "QuantitativeAnalyses";

  /**
   * Name of this subclass in SimpleClassName format
   * @return __type
   **/
  @Schema(required = true, description = "Name of this subclass in SimpleClassName format", allowableValues = {"QuantitativeAnalyses"},
  defaultValue = "QuantitativeAnalyses")
  @NotNull
  ...
  public QuantitativeAnalyses unitaryResults(String unitaryResults) {
  ...
  public QuantitativeAnalyses intersectionalResults(String intersectionalResults) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QuantitativeAnalyses quantitativeAnalyses = (QuantitativeAnalyses) o;
    return Objects.equals(this.unitaryResults, quantitativeAnalyses.unitaryResults) &&
        Objects.equals(this.intersectionalResults, quantitativeAnalyses.intersectionalResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuantitativeAnalyses {\n");
