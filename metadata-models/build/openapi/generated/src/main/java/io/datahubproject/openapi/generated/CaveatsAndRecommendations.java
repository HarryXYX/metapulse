...
public class CaveatsAndRecommendations  implements OneOfMLModelSnapshotAspectsItems, OneOfVersionedAspectAspect {
  ...
  @JsonProperty(value = "__type", defaultValue = "CaveatsAndRecommendations") @Builder.Default
  private String __type = "CaveatsAndRecommendations";

  /**
   * Name of this subclass in SimpleClassName format
   * @return __type
   **/
  @Schema(required = true, description = "Name of this subclass in SimpleClassName format", allowableValues = {"CaveatsAndRecommendations"},
  defaultValue = "CaveatsAndRecommendations")
  @NotNull
  ...
  public CaveatsAndRecommendations caveats(CaveatDetails caveats) {
  ...
  public CaveatsAndRecommendations recommendations(String recommendations) {
  ...
  public CaveatsAndRecommendations idealDatasetCharacteristics(List<String> idealDatasetCharacteristics) {
    this.idealDatasetCharacteristics = idealDatasetCharacteristics;
    return this;
  }

  public CaveatsAndRecommendations addIdealDatasetCharacteristicsItem(String idealDatasetCharacteristicsItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CaveatsAndRecommendations caveatsAndRecommendations = (CaveatsAndRecommendations) o;
    return Objects.equals(this.caveats, caveatsAndRecommendations.caveats) &&
        Objects.equals(this.recommendations, caveatsAndRecommendations.recommendations) &&
        Objects.equals(this.idealDatasetCharacteristics, caveatsAndRecommendations.idealDatasetCharacteristics);
  }
