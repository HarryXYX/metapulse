...
public class RelationshipFilter   {
  ...
  @JsonProperty("direction") @Builder.Default
  private RelationshipDirection direction = null;

  public RelationshipFilter or(List<ConjunctiveCriterion> or) {
    this.or = or;
    return this;
  }

  public RelationshipFilter addOrItem(ConjunctiveCriterion orItem) {
    if (this.or == null) {
  ...
  public RelationshipFilter criteria(List<Criterion> criteria) {
    this.criteria = criteria;
    return this;
  }

  public RelationshipFilter addCriteriaItem(Criterion criteriaItem) {
  ...
  public RelationshipFilter direction(RelationshipDirection direction) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RelationshipFilter relationshipFilter = (RelationshipFilter) o;
    return Objects.equals(this.or, relationshipFilter.or) &&
        Objects.equals(this.criteria, relationshipFilter.criteria) &&
        Objects.equals(this.direction, relationshipFilter.direction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(or, criteria, direction);
  }
