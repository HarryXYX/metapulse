 ...
 */
@Schema(description = "A standardized settings template for a feature.")
@Validated
...
public class FeatureSettings   {
  ...
  public FeatureSettings enabled(Boolean enabled) {
  ...
  public FeatureSettings config(String config) {
    this.config = config;
    return this;
  }
  ...
  public FeatureSettings configVersion(String configVersion) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.enabled, featureSettings.enabled) &&
        Objects.equals(this.config, featureSettings.config) &&
        Objects.equals(this.configVersion, featureSettings.configVersion);
  }
