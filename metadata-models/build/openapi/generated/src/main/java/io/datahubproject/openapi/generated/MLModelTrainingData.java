...
public class MLModelTrainingData  implements OneOfEnvelopedAspectValue, OneOfGenericAspectValue {

  @Getter(value = lombok.AccessLevel.NONE)
  @JsonProperty(value = "__type", defaultValue = "MLModelTrainingData") @Builder.Default
  private String __type = "MLModelTrainingData";

  /**
   * Name of this subclass in SimpleClassName format
   * @return __type
   **/
  @Schema(required = true, description = "Name of this subclass in SimpleClassName format", allowableValues = {"MLModelTrainingData"},
  defaultValue = "MLModelTrainingData")
  @NotNull
  ...
  public MLModelTrainingData trainingData(List<BaseData> trainingData) {
    this.trainingData = trainingData;
    return this;
  }

  public MLModelTrainingData addTrainingDataItem(BaseData trainingDataItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MLModelTrainingData mlModelTrainingData = (MLModelTrainingData) o;
    return Objects.equals(this.trainingData, mlModelTrainingData.trainingData);
  }
  ...
  public String toString() {
    ...
    sb.append("class MLModelTrainingData {\n");
