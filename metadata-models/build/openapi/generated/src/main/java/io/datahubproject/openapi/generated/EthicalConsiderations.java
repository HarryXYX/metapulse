...
public class EthicalConsiderations  implements OneOfMLModelSnapshotAspectsItems, OneOfVersionedAspectAspect {

  @Getter(value = lombok.AccessLevel.NONE)
  @JsonProperty(value = "__type", defaultValue = "EthicalConsiderations") @Builder.Default
  private String __type = "EthicalConsiderations";

  /**
   * Name of this subclass in SimpleClassName format
   * @return __type
   **/
  @Schema(required = true, description = "Name of this subclass in SimpleClassName format", allowableValues = {"EthicalConsiderations"},
  defaultValue = "EthicalConsiderations")
  @NotNull
  ...
  public EthicalConsiderations data(List<String> data) {
    this.data = data;
    return this;
  }

  public EthicalConsiderations addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public EthicalConsiderations humanLife(List<String> humanLife) {
    this.humanLife = humanLife;
    return this;
  }

  public EthicalConsiderations addHumanLifeItem(String humanLifeItem) {
  ...
  public EthicalConsiderations mitigations(List<String> mitigations) {
    this.mitigations = mitigations;
    return this;
  }

  public EthicalConsiderations addMitigationsItem(String mitigationsItem) {
  ...
  public EthicalConsiderations risksAndHarms(List<String> risksAndHarms) {
    this.risksAndHarms = risksAndHarms;
    return this;
  }

  public EthicalConsiderations addRisksAndHarmsItem(String risksAndHarmsItem) {
  ...
  public EthicalConsiderations useCases(List<String> useCases) {
    this.useCases = useCases;
    return this;
  }

  public EthicalConsiderations addUseCasesItem(String useCasesItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EthicalConsiderations ethicalConsiderations = (EthicalConsiderations) o;
    return Objects.equals(this.data, ethicalConsiderations.data) &&
        Objects.equals(this.humanLife, ethicalConsiderations.humanLife) &&
        Objects.equals(this.mitigations, ethicalConsiderations.mitigations) &&
        Objects.equals(this.risksAndHarms, ethicalConsiderations.risksAndHarms) &&
        Objects.equals(this.useCases, ethicalConsiderations.useCases);
  }
  ...
  public String toString() {
    ...
    sb.append("class EthicalConsiderations {\n");
