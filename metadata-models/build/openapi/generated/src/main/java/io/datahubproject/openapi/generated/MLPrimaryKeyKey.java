...
public class MLPrimaryKeyKey  implements OneOfEnvelopedAspectValue, OneOfGenericAspectValue, OneOfMLPrimaryKeySnapshotAspectsItems {
  ...
  @JsonProperty(value = "__type", defaultValue = "MLPrimaryKeyKey") @Builder.Default
  private String __type = "MLPrimaryKeyKey";

  /**
   * Name of this subclass in SimpleClassName format
   * @return __type
   **/
  @Schema(required = true, description = "Name of this subclass in SimpleClassName format", allowableValues = {"MLPrimaryKeyKey"},
  defaultValue = "MLPrimaryKeyKey")
  @NotNull
  ...
  public MLPrimaryKeyKey featureNamespace(String featureNamespace) {
  ...
  public MLPrimaryKeyKey name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MLPrimaryKeyKey mlPrimaryKeyKey = (MLPrimaryKeyKey) o;
    return Objects.equals(this.featureNamespace, mlPrimaryKeyKey.featureNamespace) &&
        Objects.equals(this.name, mlPrimaryKeyKey.name);
  }
