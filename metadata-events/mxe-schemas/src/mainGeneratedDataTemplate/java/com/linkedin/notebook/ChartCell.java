 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-events/mxe-schemas/src/main/pegasus/com/linkedin/notebook/ChartCell.pdl.")
public class ChartCell
    extends RecordTemplate
{

    private final static ChartCell.Fields _fields = new ChartCell.Fields();
    ...
    private ChartCell.ChangeListener __changeListener = new ChartCell.ChangeListener(this);
    ...
    public ChartCell(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static ChartCell.Fields fields() {
        return _fields;
    }

    public static ChartCell.ProjectionMask createMask() {
        return new ChartCell.ProjectionMask();
    }
     ...
     * 
     * @see ChartCell.Fields#cellTitle
     */
     ...
     * 
     * @see ChartCell.Fields#changeAuditStamps
     */
     ...
     * @see ChartCell.Fields#changeAuditStamps
     */
    public ChartCell setChangeAuditStamps(
        @Nullable
    ...
    {
        ChartCell __clone = ((ChartCell) super.clone());
        __clone.__changeListener = new ChartCell.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public ChartCell copy()
        throws CloneNotSupportedException
    {
        ChartCell __copy = ((ChartCell) super.copy());
        __copy._changeAuditStampsField = null;
        __copy._cellIdField = null;
        __copy._cellTitleField = null;
        __copy.__changeListener = new ChartCell.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private ChangeListener(ChartCell reference) {
        ...
        extends MaskMap
    {
         ...
         * 
         */
        public ChartCell.ProjectionMask withCellTitle() {
         ...
         * 
         */
        public ChartCell.ProjectionMask withCellId() {
         ...
         * 
         */
        public ChartCell.ProjectionMask withChangeAuditStamps(Function<com.linkedin.common.ChangeAuditStamps.ProjectionMask, com.linkedin.common.ChangeAuditStamps.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public ChartCell.ProjectionMask withChangeAuditStamps(MaskMap nestedMask) {
         ...
         * 
         */
        public ChartCell.ProjectionMask withChangeAuditStamps() {
