 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-events/mxe-schemas/src/main/pegasus/com/linkedin/assertion/IncrementingSegmentRowCountTotal.pdl.")
public class IncrementingSegmentRowCountTotal
    extends RecordTemplate
{

    private final static IncrementingSegmentRowCountTotal.Fields _fields = new IncrementingSegmentRowCountTotal.Fields();
    ...
    private IncrementingSegmentRowCountTotal.ChangeListener __changeListener = new IncrementingSegmentRowCountTotal.ChangeListener(this);
    ...
    public static IncrementingSegmentRowCountTotal.Fields fields() {
        return _fields;
    }

    public static IncrementingSegmentRowCountTotal.ProjectionMask createMask() {
        return new IncrementingSegmentRowCountTotal.ProjectionMask();
    }
     ...
     * 
     * @see IncrementingSegmentRowCountTotal.Fields#segment
     */
     ...
     * @see IncrementingSegmentRowCountTotal.Fields#segment
     */
    public IncrementingSegmentRowCountTotal setSegment(
        @Nullable
     ...
     * 
     * @see IncrementingSegmentRowCountTotal.Fields#operator
     */
     ...
     * @see IncrementingSegmentRowCountTotal.Fields#operator
     */
    public IncrementingSegmentRowCountTotal setOperator(
        @Nullable
     ...
     * 
     * @see IncrementingSegmentRowCountTotal.Fields#parameters
     */
     ...
     * @see IncrementingSegmentRowCountTotal.Fields#parameters
     */
    public IncrementingSegmentRowCountTotal setParameters(
        @Nullable
    ...
    @Override
    public IncrementingSegmentRowCountTotal clone()
        throws CloneNotSupportedException
    {
        IncrementingSegmentRowCountTotal __clone = ((IncrementingSegmentRowCountTotal) super.clone());
        __clone.__changeListener = new IncrementingSegmentRowCountTotal.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public IncrementingSegmentRowCountTotal copy()
        throws CloneNotSupportedException
    {
        ...
        __copy.__changeListener = new IncrementingSegmentRowCountTotal.ChangeListener(__copy);
        ...
        extends MaskMap
    {
         ...
         * 
         */
        public IncrementingSegmentRowCountTotal.ProjectionMask withSegment(Function<com.linkedin.assertion.IncrementingSegmentSpec.ProjectionMask, com.linkedin.assertion.IncrementingSegmentSpec.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public IncrementingSegmentRowCountTotal.ProjectionMask withSegment() {
            _segmentMask = null;
         ...
         * 
         */
        public IncrementingSegmentRowCountTotal.ProjectionMask withOperator() {
         ...
         * 
         */
        public IncrementingSegmentRowCountTotal.ProjectionMask withParameters(Function<com.linkedin.assertion.AssertionStdParameters.ProjectionMask, com.linkedin.assertion.AssertionStdParameters.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public IncrementingSegmentRowCountTotal.ProjectionMask withParameters() {
