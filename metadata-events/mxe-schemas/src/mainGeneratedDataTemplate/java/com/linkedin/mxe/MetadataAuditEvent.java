    ...
    extends RecordTemplate
{
    ...
    private MetadataAuditEvent.ChangeListener __changeListener = new MetadataAuditEvent.ChangeListener(this);
    private final static RecordDataSchema.Field FIELD_AuditHeader = SCHEMA.getField("auditHeader");
    private final static RecordDataSchema.Field FIELD_OldSnapshot = SCHEMA.getField("oldSnapshot");
    private final static RecordDataSchema.Field FIELD_OldSystemMetadata = SCHEMA.getField("oldSystemMetadata");
    private final static RecordDataSchema.Field FIELD_NewSnapshot = SCHEMA.getField("newSnapshot");
    private final static RecordDataSchema.Field FIELD_NewSystemMetadata = SCHEMA.getField("newSystemMetadata");
    ...
    public static MetadataAuditEvent.Fields fields() {
        return _fields;
    }

    public static MetadataAuditEvent.ProjectionMask createMask() {
        return new MetadataAuditEvent.ProjectionMask();
    }
     ...
     * 
     * @see MetadataAuditEvent.Fields#auditHeader
     */
     ...
     * @see MetadataAuditEvent.Fields#auditHeader
     */
    public MetadataAuditEvent setAuditHeader(
        @Nullable
    ...
    /**
     * Existence checker for oldSnapshot
     * 
     * @see MetadataAuditEvent.Fields#oldSnapshot
     */
    public boolean hasOldSnapshot() {
        if (_oldSnapshotField!= null) {
            return true;
        }
        return super._map.containsKey("oldSnapshot");
    }

    /**
     * Remover for oldSnapshot
     * 
     * @see MetadataAuditEvent.Fields#oldSnapshot
     */
    public void removeOldSnapshot() {
        super._map.remove("oldSnapshot");
    }

    /**
     * Getter for oldSnapshot
     * 
     * @see MetadataAuditEvent.Fields#oldSnapshot
     */
    @Nullable
    public Snapshot getOldSnapshot(GetMode mode) {
        return getOldSnapshot();
    }
    ...
    public Snapshot getOldSnapshot() {
        if (_oldSnapshotField!= null) {
            return _oldSnapshotField;
        } else {
            Object __rawValue = super._map.get("oldSnapshot");
            _oldSnapshotField = ((__rawValue == null)?null:new Snapshot(__rawValue));
            return _oldSnapshotField;
        }
    }

    /**
     * Setter for oldSnapshot
     * 
     * @see MetadataAuditEvent.Fields#oldSnapshot
     */
    public MetadataAuditEvent setOldSnapshot(
        @Nullable
        Snapshot value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setOldSnapshot(value);
            case REMOVE_OPTIONAL_IF_NULL:
            case REMOVE_IF_NULL:
                if (value == null) {
                    removeOldSnapshot();
                } else {
                    CheckedUtil.putWithoutChecking(super._map, "oldSnapshot", value.data());
                    _oldSnapshotField = value;
                }
                break;
            case IGNORE_NULL:
                if (value!= null) {
    ...
    /**
     * Existence checker for oldSystemMetadata
     * 
     * @see MetadataAuditEvent.Fields#oldSystemMetadata
     */
    public boolean hasOldSystemMetadata() {
        if (_oldSystemMetadataField!= null) {
            return true;
        }
        return super._map.containsKey("oldSystemMetadata");
    }

    /**
     * Remover for oldSystemMetadata
     * 
     * @see MetadataAuditEvent.Fields#oldSystemMetadata
     */
    public void removeOldSystemMetadata() {
        super._map.remove("oldSystemMetadata");
    }

    /**
     * Getter for oldSystemMetadata
     * 
     * @see MetadataAuditEvent.Fields#oldSystemMetadata
     */
    @Nullable
    public SystemMetadata getOldSystemMetadata(GetMode mode) {
        return getOldSystemMetadata();
    }
    ...
    public SystemMetadata getOldSystemMetadata() {
        if (_oldSystemMetadataField!= null) {
            return _oldSystemMetadataField;
        } else {
            Object __rawValue = super._map.get("oldSystemMetadata");
            _oldSystemMetadataField = ((__rawValue == null)?null:new SystemMetadata(DataTemplateUtil.castOrThrow(__rawValue, DataMap.class)));
            return _oldSystemMetadataField;
        }
    }

    /**
     * Setter for oldSystemMetadata
     * 
     * @see MetadataAuditEvent.Fields#oldSystemMetadata
     */
    public MetadataAuditEvent setOldSystemMetadata(
        @Nullable
        SystemMetadata value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setOldSystemMetadata(value);
            case REMOVE_OPTIONAL_IF_NULL:
            case REMOVE_IF_NULL:
                if (value == null) {
                    removeOldSystemMetadata();
                } else {
                    CheckedUtil.putWithoutChecking(super._map, "oldSystemMetadata", value.data());
                    _oldSystemMetadataField = value;
                }
                break;
            case IGNORE_NULL:
                if (value!= null) {
    ...
    /**
     * Existence checker for newSnapshot
     * 
     * @see MetadataAuditEvent.Fields#newSnapshot
     */
    public boolean hasNewSnapshot() {
        if (_newSnapshotField!= null) {
            return true;
        }
        return super._map.containsKey("newSnapshot");
    }

    /**
     * Remover for newSnapshot
     * 
     * @see MetadataAuditEvent.Fields#newSnapshot
     */
    public void removeNewSnapshot() {
        super._map.remove("newSnapshot");
    }

    /**
     * Getter for newSnapshot
     * 
     * @see MetadataAuditEvent.Fields#newSnapshot
     */
    @Nullable
    public Snapshot getNewSnapshot(GetMode mode) {
        switch (mode) {
            case STRICT:
                return getNewSnapshot();
            case DEFAULT:
            case NULL:
                if (_newSnapshotField!= null) {
                    return _newSnapshotField;
                } else {
                    Object __rawValue = super._map.get("newSnapshot");
                    _newSnapshotField = ((__rawValue == null)?null:new Snapshot(__rawValue));
                    return _newSnapshotField;
                }
        }
    ...
    /**
     * Setter for newSnapshot
     * 
     * @see MetadataAuditEvent.Fields#newSnapshot
     */
    public MetadataAuditEvent setNewSnapshot(
        @Nullable
        Snapshot value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setNewSnapshot(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field newSnapshot of com.linkedin.mxe.MetadataAuditEvent");
                } else {
                    CheckedUtil.putWithoutChecking(super._map, "newSnapshot", value.data());
                    _newSnapshotField = value;
                }
                break;
            case REMOVE_IF_NULL:
                if (value == null) {
    ...
    /**
     * Existence checker for newSystemMetadata
     * 
     * @see MetadataAuditEvent.Fields#newSystemMetadata
     */
    public boolean hasNewSystemMetadata() {
        if (_newSystemMetadataField!= null) {
            return true;
        }
        return super._map.containsKey("newSystemMetadata");
    }

    /**
     * Remover for newSystemMetadata
     * 
     * @see MetadataAuditEvent.Fields#newSystemMetadata
     */
    public void removeNewSystemMetadata() {
        super._map.remove("newSystemMetadata");
    }

    /**
     * Getter for newSystemMetadata
     * 
     * @see MetadataAuditEvent.Fields#newSystemMetadata
     */
    @Nullable
    public SystemMetadata getNewSystemMetadata(GetMode mode) {
        return getNewSystemMetadata();
    }
    ...
    public SystemMetadata getNewSystemMetadata() {
        if (_newSystemMetadataField!= null) {
            return _newSystemMetadataField;
        } else {
            Object __rawValue = super._map.get("newSystemMetadata");
            _newSystemMetadataField = ((__rawValue == null)?null:new SystemMetadata(DataTemplateUtil.castOrThrow(__rawValue, DataMap.class)));
            return _newSystemMetadataField;
        }
    }

    /**
     * Setter for newSystemMetadata
     * 
     * @see MetadataAuditEvent.Fields#newSystemMetadata
     */
    public MetadataAuditEvent setNewSystemMetadata(
        @Nullable
        SystemMetadata value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setNewSystemMetadata(value);
            case REMOVE_OPTIONAL_IF_NULL:
            case REMOVE_IF_NULL:
                if (value == null) {
                    removeNewSystemMetadata();
                } else {
                    CheckedUtil.putWithoutChecking(super._map, "newSystemMetadata", value.data());
                    _newSystemMetadataField = value;
                }
                break;
            case IGNORE_NULL:
                if (value!= null) {
     ...
     * 
     * @see MetadataAuditEvent.Fields#operation
     */
    ...
    public MetadataAuditOperation getOperation() {
        if (_operationField!= null) {
            ...
            _operationField = DataTemplateUtil.coerceEnumOutput(__rawValue, MetadataAuditOperation.class, MetadataAuditOperation.$UNKNOWN);
            return _operationField;
        }
    }
     ...
     * @see MetadataAuditEvent.Fields#operation
     */
    public MetadataAuditEvent setOperation(
        @Nullable
        MetadataAuditOperation value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
    ...
    @Override
    public MetadataAuditEvent clone()
        throws CloneNotSupportedException
    {
        MetadataAuditEvent __clone = ((MetadataAuditEvent) super.clone());
        __clone.__changeListener = new MetadataAuditEvent.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public MetadataAuditEvent copy()
        throws CloneNotSupportedException
    {
        ...
        __copy.__changeListener = new MetadataAuditEvent.ChangeListener(__copy);
        ...
        public void onUnderlyingMapChanged(String key, Object value) {
            switch (key) {
                case "auditHeader":
                    ...
                    break;
                case "newSnapshot":
                    __objectRef._newSnapshotField = null;
                    break;
                case "oldSystemMetadata":
                    __objectRef._oldSystemMetadataField = null;
                    break;
                case "operation":
                    __objectRef._operationField = null;
                    break;
                case "oldSnapshot":
                    __objectRef._oldSnapshotField = null;
                    break;
                case "newSystemMetadata":
                    __objectRef._newSystemMetadataField = null;
                    break;
            }
        }
        ...
        extends PathSpec
    {
         ...
         * 
         */
        public com.linkedin.metadata.snapshot.Snapshot.Fields oldSnapshot() {
            return new com.linkedin.metadata.snapshot.Snapshot.Fields(getPathComponents(), "oldSnapshot");
        }
         ...
         * 
         */
        public com.linkedin.mxe.SystemMetadata.Fields oldSystemMetadata() {
            return new com.linkedin.mxe.SystemMetadata.Fields(getPathComponents(), "oldSystemMetadata");
        }
         ...
         * 
         */
        public com.linkedin.metadata.snapshot.Snapshot.Fields newSnapshot() {
            return new com.linkedin.metadata.snapshot.Snapshot.Fields(getPathComponents(), "newSnapshot");
        }
         ...
         * 
         */
        public com.linkedin.mxe.SystemMetadata.Fields newSystemMetadata() {
            return new com.linkedin.mxe.SystemMetadata.Fields(getPathComponents(), "newSystemMetadata");
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.snapshot.Snapshot.ProjectionMask _oldSnapshotMask;
        private com.linkedin.mxe.SystemMetadata.ProjectionMask _oldSystemMetadataMask;
        private com.linkedin.metadata.snapshot.Snapshot.ProjectionMask _newSnapshotMask;
        private com.linkedin.mxe.SystemMetadata.ProjectionMask _newSystemMetadataMask;
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withAuditHeader(Function<com.linkedin.avro2pegasus.events.KafkaAuditHeader.ProjectionMask, com.linkedin.avro2pegasus.events.KafkaAuditHeader.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withAuditHeader() {
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withOldSnapshot(Function<com.linkedin.metadata.snapshot.Snapshot.ProjectionMask, com.linkedin.metadata.snapshot.Snapshot.ProjectionMask> nestedMask) {
            _oldSnapshotMask = nestedMask.apply(((_oldSnapshotMask == null)?Snapshot.createMask():_oldSnapshotMask));
            getDataMap().put("oldSnapshot", _oldSnapshotMask.getDataMap());
            return this;
        }
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withOldSnapshot() {
            _oldSnapshotMask = null;
            getDataMap().put("oldSnapshot", MaskMap.POSITIVE_MASK);
            return this;
        }
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withOldSystemMetadata(Function<com.linkedin.mxe.SystemMetadata.ProjectionMask, com.linkedin.mxe.SystemMetadata.ProjectionMask> nestedMask) {
            _oldSystemMetadataMask = nestedMask.apply(((_oldSystemMetadataMask == null)?SystemMetadata.createMask():_oldSystemMetadataMask));
            getDataMap().put("oldSystemMetadata", _oldSystemMetadataMask.getDataMap());
            return this;
        }
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withOldSystemMetadata() {
            _oldSystemMetadataMask = null;
            getDataMap().put("oldSystemMetadata", MaskMap.POSITIVE_MASK);
            return this;
        }
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withNewSnapshot(Function<com.linkedin.metadata.snapshot.Snapshot.ProjectionMask, com.linkedin.metadata.snapshot.Snapshot.ProjectionMask> nestedMask) {
            _newSnapshotMask = nestedMask.apply(((_newSnapshotMask == null)?Snapshot.createMask():_newSnapshotMask));
            getDataMap().put("newSnapshot", _newSnapshotMask.getDataMap());
            return this;
        }
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withNewSnapshot() {
            _newSnapshotMask = null;
            getDataMap().put("newSnapshot", MaskMap.POSITIVE_MASK);
            return this;
        }
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withNewSystemMetadata(Function<com.linkedin.mxe.SystemMetadata.ProjectionMask, com.linkedin.mxe.SystemMetadata.ProjectionMask> nestedMask) {
            _newSystemMetadataMask = nestedMask.apply(((_newSystemMetadataMask == null)?SystemMetadata.createMask():_newSystemMetadataMask));
            getDataMap().put("newSystemMetadata", _newSystemMetadataMask.getDataMap());
            return this;
        }
         ...
         * 
         */
        public MetadataAuditEvent.ProjectionMask withNewSystemMetadata() {
            _newSystemMetadataMask = null;
            getDataMap().put("newSystemMetadata", MaskMap.POSITIVE_MASK);
            return this;
        }

        public MetadataAuditEvent.ProjectionMask withOperation() {
