 ...
 * 
 * @deprecated
 *     This format of request builder is obsolete. Please use {@link com.linkedin.entity.EntitiesRequestBuilders} instead.
 */
...
public class EntitiesBuilders {
    ...
    public EntitiesBuilders() {
        this(RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public EntitiesBuilders(RestliRequestOptions requestOptions) {
        _baseUriTemplate = ORIGINAL_RESOURCE_PATH;
        _requestOptions = assignRequestOptions(requestOptions);
    }

    public EntitiesBuilders(java.lang.String primaryResourceName) {
        this(primaryResourceName, RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public EntitiesBuilders(java.lang.String primaryResourceName, RestliRequestOptions requestOptions) {
     ...
     */
    public EntitiesGetBuilder get() {
        return new EntitiesGetBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public EntitiesBatchGetBuilder batchGet() {
        return new EntitiesBatchGetBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public EntitiesDoApplyRetentionBuilder actionApplyRetention() {
        return new EntitiesDoApplyRetentionBuilder(getBaseUriTemplate(), java.lang.String.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoAutocompleteBuilder actionAutocomplete() {
        return new EntitiesDoAutocompleteBuilder(getBaseUriTemplate(), AutoCompleteResult.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoBatchGetTotalEntityCountBuilder actionBatchGetTotalEntityCount() {
        return new EntitiesDoBatchGetTotalEntityCountBuilder(getBaseUriTemplate(), LongMap.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoBatchIngestBuilder actionBatchIngest() {
        return new EntitiesDoBatchIngestBuilder(getBaseUriTemplate(), Void.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoBrowseBuilder actionBrowse() {
        return new EntitiesDoBrowseBuilder(getBaseUriTemplate(), BrowseResult.class, _resourceSpec, getRequestOptions());
    }
     ...
     *     builder for the resource method
     */
    public EntitiesDoDeleteBuilder actionDelete() {
        return new EntitiesDoDeleteBuilder(getBaseUriTemplate(), DeleteEntityResponse.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoDeleteAllBuilder actionDeleteAll() {
        return new EntitiesDoDeleteAllBuilder(getBaseUriTemplate(), RollbackResponse.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoDeleteReferencesBuilder actionDeleteReferences() {
        return new EntitiesDoDeleteReferencesBuilder(getBaseUriTemplate(), DeleteReferencesResponse.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoExistsBuilder actionExists() {
        return new EntitiesDoExistsBuilder(getBaseUriTemplate(), Boolean.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoFilterBuilder actionFilter() {
        return new EntitiesDoFilterBuilder(getBaseUriTemplate(), SearchResult.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoGetBrowsePathsBuilder actionGetBrowsePaths() {
        return new EntitiesDoGetBrowsePathsBuilder(getBaseUriTemplate(), StringArray.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoGetTotalEntityCountBuilder actionGetTotalEntityCount() {
        return new EntitiesDoGetTotalEntityCountBuilder(getBaseUriTemplate(), Long.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoIngestBuilder actionIngest() {
        return new EntitiesDoIngestBuilder(getBaseUriTemplate(), Void.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoListBuilder actionList() {
        return new EntitiesDoListBuilder(getBaseUriTemplate(), ListResult.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoListUrnsBuilder actionListUrns() {
        return new EntitiesDoListUrnsBuilder(getBaseUriTemplate(), ListUrnsResult.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoScrollAcrossEntitiesBuilder actionScrollAcrossEntities() {
        return new EntitiesDoScrollAcrossEntitiesBuilder(getBaseUriTemplate(), ScrollResult.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoScrollAcrossLineageBuilder actionScrollAcrossLineage() {
        return new EntitiesDoScrollAcrossLineageBuilder(getBaseUriTemplate(), LineageScrollResult.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoSearchBuilder actionSearch() {
        return new EntitiesDoSearchBuilder(getBaseUriTemplate(), SearchResult.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoSearchAcrossEntitiesBuilder actionSearchAcrossEntities() {
        return new EntitiesDoSearchAcrossEntitiesBuilder(getBaseUriTemplate(), SearchResult.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoSearchAcrossLineageBuilder actionSearchAcrossLineage() {
        return new EntitiesDoSearchAcrossLineageBuilder(getBaseUriTemplate(), LineageSearchResult.class, _resourceSpec, getRequestOptions());
    }

    public EntitiesDoSetWritableBuilder actionSetWritable() {
        return new EntitiesDoSetWritableBuilder(getBaseUriTemplate(), Void.class, _resourceSpec, getRequestOptions());
    }
