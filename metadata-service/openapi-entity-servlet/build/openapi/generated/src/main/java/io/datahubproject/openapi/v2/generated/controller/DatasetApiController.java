...
public class DatasetApiController implements DatasetApi {
    ...
    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.DatasetEntityRequestV2, io.datahubproject.openapi.generated.DatasetEntityResponseV2, io.datahubproject.openapi.generated.ScrollDatasetEntityResponseV2> delegate;
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.DatasetEntityRequestV2, io.datahubproject.openapi.generated.DatasetEntityResponseV2, io.datahubproject.openapi.generated.ScrollDatasetEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.DatasetEntityRequestV2.class, io.datahubproject.openapi.generated.DatasetEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollDatasetEntityResponseV2.class);
    }
    ...
    public ResponseEntity<EditableDatasetPropertiesAspectResponseV2> createEditableDatasetProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.DEFAULT, description = "Create aspect editableDatasetProperties on Dataset entity.", required=true, schema=@Schema()) @Valid @RequestBody EditableDatasetPropertiesAspectRequestV2 body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
        return delegate.createEditableDatasetProperties(body, urn, createIfNotExists, createEntityIfNotExists);
    }
    ...
    @Override
    public ResponseEntity<Void> deleteBrowsePathsV2(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.deleteBrowsePathsV2(urn);
    }

    @Override
    public ResponseEntity<Void> deleteDatasetProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.deleteDatasetProperties(urn);
    }
    ...
    @Override
    public ResponseEntity<Void> deleteEditableDatasetProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.deleteEditableDatasetProperties(urn);
    }
    ...
    public ResponseEntity<BrowsePathsV2AspectResponseV2> getBrowsePathsV2(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata) {
        return delegate.getBrowsePathsV2(urn, systemMetadata);
    }

    @Override
    public ResponseEntity<DatasetPropertiesAspectResponseV2> getDatasetProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata) {
        return delegate.getDatasetProperties(urn, systemMetadata);
    }
    ...
    @Override
    public ResponseEntity<EditableDatasetPropertiesAspectResponseV2> getEditableDatasetProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata) {
        return delegate.getEditableDatasetProperties(urn, systemMetadata);
    }
    ...
    @Override
    public ResponseEntity<Void> headBrowsePathsV2(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.headBrowsePathsV2(urn);
    }

    @Override
    public ResponseEntity<Void> headDatasetProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.headDatasetProperties(urn);
    }
    ...
    @Override
    public ResponseEntity<Void> headEditableDatasetProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.headEditableDatasetProperties(urn);
    }
    ...
    @Override
    public ResponseEntity<ScrollDatasetEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "viewProperties", "subTypes", "datasetProfile", "datasetUsageStatistics", "operation", "domains", "applications", "schemaMetadata", "status", "container", "deprecation", "testResults", "siblings", "embed", "incidentsSummary", "datasetProperties", "editableDatasetProperties", "datasetDeprecation", "datasetUpstreamLineage", "upstreamLineage", "institutionalMemory", "ownership", "editableSchemaMetadata", "globalTags", "glossaryTerms", "browsePaths", "dataPlatformInstance", "browsePathsV2", "access", "structuredProperties", "forms", "partitionsSummary", "versionProperties", "icebergCatalogInfo", "logicalParent" }
