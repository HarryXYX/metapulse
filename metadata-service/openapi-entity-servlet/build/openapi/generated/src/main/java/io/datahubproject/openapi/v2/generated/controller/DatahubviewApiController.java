...
import io.datahubproject.openapi.generated.DataHubViewEntityRequestV2;
import io.datahubproject.openapi.generated.DataHubViewEntityResponseV2;
import io.datahubproject.openapi.generated.ScrollDataHubViewEntityResponseV2;
...
public class DatahubviewApiController implements DatahubviewApi {

    private static final Logger log = LoggerFactory.getLogger(DatahubviewApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataHubViewEntityRequestV2, io.datahubproject.openapi.generated.DataHubViewEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataHubViewEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public DatahubviewApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataHubViewEntityRequestV2, io.datahubproject.openapi.generated.DataHubViewEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataHubViewEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.DataHubViewEntityRequestV2.class, io.datahubproject.openapi.generated.DataHubViewEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollDataHubViewEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<DataHubViewEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create dataHubView entities.", required=true, schema=@Schema()) @Valid @RequestBody List<DataHubViewEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
    ...
    @Override
    public ResponseEntity<ScrollDataHubViewEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "dataHubViewInfo" }
