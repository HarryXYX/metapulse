...
import io.datahubproject.openapi.generated.IncidentEntityRequestV2;
import io.datahubproject.openapi.generated.IncidentEntityResponseV2;
import io.datahubproject.openapi.generated.ScrollIncidentEntityResponseV2;
...
public class IncidentApiController implements IncidentApi {
    ...
    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.IncidentEntityRequestV2, io.datahubproject.openapi.generated.IncidentEntityResponseV2, io.datahubproject.openapi.generated.ScrollIncidentEntityResponseV2> delegate;
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.IncidentEntityRequestV2, io.datahubproject.openapi.generated.IncidentEntityResponseV2, io.datahubproject.openapi.generated.ScrollIncidentEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.IncidentEntityRequestV2.class, io.datahubproject.openapi.generated.IncidentEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollIncidentEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<ScrollIncidentEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "incidentInfo", "globalTags" }
