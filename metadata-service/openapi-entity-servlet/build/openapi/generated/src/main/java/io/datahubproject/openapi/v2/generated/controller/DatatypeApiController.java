...
import io.datahubproject.openapi.generated.DataTypeEntityRequestV2;
...
import io.datahubproject.openapi.generated.ScrollDataTypeEntityResponseV2;
...
public class DatatypeApiController implements DatatypeApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(DatatypeApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataTypeEntityRequestV2, io.datahubproject.openapi.generated.DataTypeEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataTypeEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public DatatypeApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataTypeEntityRequestV2, io.datahubproject.openapi.generated.DataTypeEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataTypeEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.DataTypeEntityRequestV2.class, io.datahubproject.openapi.generated.DataTypeEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollDataTypeEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<ScrollDataTypeEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "dataTypeInfo", "institutionalMemory", "status" }
