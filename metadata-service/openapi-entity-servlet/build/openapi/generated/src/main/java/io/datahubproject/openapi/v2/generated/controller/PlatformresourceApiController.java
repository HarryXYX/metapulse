...
import io.datahubproject.openapi.generated.PlatformResourceEntityRequestV2;
import io.datahubproject.openapi.generated.PlatformResourceEntityResponseV2;
import io.datahubproject.openapi.generated.ScrollPlatformResourceEntityResponseV2;
...
public class PlatformresourceApiController implements PlatformresourceApi {

    private static final Logger log = LoggerFactory.getLogger(PlatformresourceApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.PlatformResourceEntityRequestV2, io.datahubproject.openapi.generated.PlatformResourceEntityResponseV2, io.datahubproject.openapi.generated.ScrollPlatformResourceEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public PlatformresourceApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.PlatformResourceEntityRequestV2, io.datahubproject.openapi.generated.PlatformResourceEntityResponseV2, io.datahubproject.openapi.generated.ScrollPlatformResourceEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.PlatformResourceEntityRequestV2.class, io.datahubproject.openapi.generated.PlatformResourceEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollPlatformResourceEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<PlatformResourceEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create platformResource entities.", required=true, schema=@Schema()) @Valid @RequestBody List<PlatformResourceEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
        return delegate.create(body, createIfNotExists, createEntityIfNotExists);
    }

    @Override
    public ResponseEntity<StatusAspectResponseV2> createStatus(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.DEFAULT, description = "Create aspect status on PlatformResource entity.", required=true, schema=@Schema()) @Valid @RequestBody StatusAspectRequestV2 body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
