...
public class DataflowApiController implements DataflowApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(DataflowApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataFlowEntityRequestV2, io.datahubproject.openapi.generated.DataFlowEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataFlowEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public DataflowApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataFlowEntityRequestV2, io.datahubproject.openapi.generated.DataFlowEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataFlowEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.DataFlowEntityRequestV2.class, io.datahubproject.openapi.generated.DataFlowEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollDataFlowEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<ScrollDataFlowEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "domains", "applications", "deprecation", "versionInfo", "dataFlowInfo", "editableDataFlowProperties", "ownership", "status", "globalTags", "browsePaths", "glossaryTerms", "institutionalMemory", "dataPlatformInstance", "container", "browsePathsV2", "structuredProperties", "incidentsSummary", "forms", "subTypes", "testResults" }
