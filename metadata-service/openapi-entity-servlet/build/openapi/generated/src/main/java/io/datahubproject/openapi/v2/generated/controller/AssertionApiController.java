...
import io.datahubproject.openapi.generated.AssertionEntityRequestV2;
import io.datahubproject.openapi.generated.AssertionEntityResponseV2;
...
import io.datahubproject.openapi.generated.ScrollAssertionEntityResponseV2;
...
public class AssertionApiController implements AssertionApi {

    private static final Logger log = LoggerFactory.getLogger(AssertionApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.AssertionEntityRequestV2, io.datahubproject.openapi.generated.AssertionEntityResponseV2, io.datahubproject.openapi.generated.ScrollAssertionEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public AssertionApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.AssertionEntityRequestV2, io.datahubproject.openapi.generated.AssertionEntityResponseV2, io.datahubproject.openapi.generated.ScrollAssertionEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.AssertionEntityRequestV2.class, io.datahubproject.openapi.generated.AssertionEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollAssertionEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<AssertionEntityResponseV2> get(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "assertionInfo", "dataPlatformInstance", "assertionRunEvent", "assertionActions", "status", "globalTags" }
    ...
    @Override
    public ResponseEntity<ScrollAssertionEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "assertionInfo", "dataPlatformInstance", "assertionRunEvent", "assertionActions", "status", "globalTags" }
