...
public class DatahubfileApiController implements DatahubfileApi {

    private static final Logger log = LoggerFactory.getLogger(DatahubfileApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataHubFileEntityRequestV2, io.datahubproject.openapi.generated.DataHubFileEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataHubFileEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public DatahubfileApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataHubFileEntityRequestV2, io.datahubproject.openapi.generated.DataHubFileEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataHubFileEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.DataHubFileEntityRequestV2.class, io.datahubproject.openapi.generated.DataHubFileEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollDataHubFileEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<ScrollDataHubFileEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "dataHubFileInfo" }
