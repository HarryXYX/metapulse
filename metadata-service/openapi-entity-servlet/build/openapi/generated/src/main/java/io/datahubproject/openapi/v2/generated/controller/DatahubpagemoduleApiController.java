...
import io.datahubproject.openapi.generated.DataHubPageModuleEntityRequestV2;
import io.datahubproject.openapi.generated.DataHubPageModuleEntityResponseV2;
import io.datahubproject.openapi.generated.ScrollDataHubPageModuleEntityResponseV2;
...
public class DatahubpagemoduleApiController implements DatahubpagemoduleApi {

    private static final Logger log = LoggerFactory.getLogger(DatahubpagemoduleApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataHubPageModuleEntityRequestV2, io.datahubproject.openapi.generated.DataHubPageModuleEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataHubPageModuleEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public DatahubpagemoduleApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataHubPageModuleEntityRequestV2, io.datahubproject.openapi.generated.DataHubPageModuleEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataHubPageModuleEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.DataHubPageModuleEntityRequestV2.class, io.datahubproject.openapi.generated.DataHubPageModuleEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollDataHubPageModuleEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<DataHubPageModuleEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create dataHubPageModule entities.", required=true, schema=@Schema()) @Valid @RequestBody List<DataHubPageModuleEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
