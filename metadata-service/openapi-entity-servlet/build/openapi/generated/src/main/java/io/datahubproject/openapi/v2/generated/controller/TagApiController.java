...
public class TagApiController implements TagApi {
    ...
    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.TagEntityRequestV2, io.datahubproject.openapi.generated.TagEntityResponseV2, io.datahubproject.openapi.generated.ScrollTagEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public TagApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.TagEntityRequestV2, io.datahubproject.openapi.generated.TagEntityResponseV2, io.datahubproject.openapi.generated.ScrollTagEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.TagEntityRequestV2.class, io.datahubproject.openapi.generated.TagEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollTagEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<TagEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create tag entities.", required=true, schema=@Schema()) @Valid @RequestBody List<TagEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
    ...
    @Override
    public ResponseEntity<ScrollTagEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "tagProperties", "ownership", "deprecation", "status", "testResults" }
