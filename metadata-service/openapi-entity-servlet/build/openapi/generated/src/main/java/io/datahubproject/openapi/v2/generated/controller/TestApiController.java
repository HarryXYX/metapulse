...
public class TestApiController implements TestApi {
    ...
    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.TestEntityRequestV2, io.datahubproject.openapi.generated.TestEntityResponseV2, io.datahubproject.openapi.generated.ScrollTestEntityResponseV2> delegate;
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.TestEntityRequestV2, io.datahubproject.openapi.generated.TestEntityResponseV2, io.datahubproject.openapi.generated.ScrollTestEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.TestEntityRequestV2.class, io.datahubproject.openapi.generated.TestEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollTestEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<TestEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create test entities.", required=true, schema=@Schema()) @Valid @RequestBody List<TestEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
    ...
    @Override
    public ResponseEntity<ScrollTestEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "testInfo" }
