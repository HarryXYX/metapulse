...
public class ChartApiController implements ChartApi {
    ...
    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.ChartEntityRequestV2, io.datahubproject.openapi.generated.ChartEntityResponseV2, io.datahubproject.openapi.generated.ScrollChartEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public ChartApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.ChartEntityRequestV2, io.datahubproject.openapi.generated.ChartEntityResponseV2, io.datahubproject.openapi.generated.ScrollChartEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.ChartEntityRequestV2.class, io.datahubproject.openapi.generated.ChartEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollChartEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<ChartEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create chart entities.", required=true, schema=@Schema()) @Valid @RequestBody List<ChartEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
    ...
    public ResponseEntity<EditableChartPropertiesAspectResponseV2> createEditableChartProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.DEFAULT, description = "Create aspect editableChartProperties on Chart entity.", required=true, schema=@Schema()) @Valid @RequestBody EditableChartPropertiesAspectRequestV2 body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
        return delegate.createEditableChartProperties(body, urn, createIfNotExists, createEntityIfNotExists);
    }
    ...
    @Override
    public ResponseEntity<Void> deleteChartInfo(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.deleteChartInfo(urn);
    }
    ...
    @Override
    public ResponseEntity<Void> deleteEditableChartProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.deleteEditableChartProperties(urn);
    }
    ...
    @Override
    public ResponseEntity<ChartInfoAspectResponseV2> getChartInfo(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata) {
        return delegate.getChartInfo(urn, systemMetadata);
    }
    ...
    @Override
    public ResponseEntity<EditableChartPropertiesAspectResponseV2> getEditableChartProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata) {
        return delegate.getEditableChartProperties(urn, systemMetadata);
    }
    ...
    @Override
    public ResponseEntity<Void> headChartInfo(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.headChartInfo(urn);
    }
    ...
    @Override
    public ResponseEntity<Void> headEditableChartProperties(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.headEditableChartProperties(urn);
    }
    ...
    @Override
    public ResponseEntity<ScrollChartEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "chartInfo", "editableChartProperties", "chartQuery", "inputFields", "chartUsageStatistics", "embed", "browsePaths", "domains", "applications", "container", "deprecation", "ownership", "status", "institutionalMemory", "dataPlatformInstance", "globalTags", "glossaryTerms", "browsePathsV2", "subTypes", "structuredProperties", "incidentsSummary", "forms", "testResults" }
