...
public class MlfeaturetableApiController implements MlfeaturetableApi {

    private static final Logger log = LoggerFactory.getLogger(MlfeaturetableApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.MLFeatureTableEntityRequestV2, io.datahubproject.openapi.generated.MLFeatureTableEntityResponseV2, io.datahubproject.openapi.generated.ScrollMLFeatureTableEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public MlfeaturetableApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.MLFeatureTableEntityRequestV2, io.datahubproject.openapi.generated.MLFeatureTableEntityResponseV2, io.datahubproject.openapi.generated.ScrollMLFeatureTableEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.MLFeatureTableEntityRequestV2.class, io.datahubproject.openapi.generated.MLFeatureTableEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollMLFeatureTableEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<ScrollMLFeatureTableEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "glossaryTerms", "domains", "applications", "mlFeatureTableProperties", "ownership", "institutionalMemory", "status", "deprecation", "browsePaths", "globalTags", "dataPlatformInstance", "browsePathsV2", "structuredProperties", "forms", "testResults", "subTypes" }
