...
import io.datahubproject.openapi.generated.ScrollVersionSetEntityResponseV2;
import io.datahubproject.openapi.generated.SortOrder;
import io.datahubproject.openapi.generated.VersionSetEntityRequestV2;
...
public class VersionsetApiController implements VersionsetApi {

    private static final Logger log = LoggerFactory.getLogger(VersionsetApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.VersionSetEntityRequestV2, io.datahubproject.openapi.generated.VersionSetEntityResponseV2, io.datahubproject.openapi.generated.ScrollVersionSetEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public VersionsetApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.VersionSetEntityRequestV2, io.datahubproject.openapi.generated.VersionSetEntityResponseV2, io.datahubproject.openapi.generated.ScrollVersionSetEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.VersionSetEntityRequestV2.class, io.datahubproject.openapi.generated.VersionSetEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollVersionSetEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<VersionSetEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create versionSet entities.", required=true, schema=@Schema()) @Valid @RequestBody List<VersionSetEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
