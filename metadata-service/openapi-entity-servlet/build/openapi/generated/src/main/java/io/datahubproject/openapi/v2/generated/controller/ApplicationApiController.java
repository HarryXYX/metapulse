...
public class ApplicationApiController implements ApplicationApi {
    ...
    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.ApplicationEntityRequestV2, io.datahubproject.openapi.generated.ApplicationEntityResponseV2, io.datahubproject.openapi.generated.ScrollApplicationEntityResponseV2> delegate;
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.ApplicationEntityRequestV2, io.datahubproject.openapi.generated.ApplicationEntityResponseV2, io.datahubproject.openapi.generated.ScrollApplicationEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.ApplicationEntityRequestV2.class, io.datahubproject.openapi.generated.ApplicationEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollApplicationEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<ScrollApplicationEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "applicationProperties", "ownership", "glossaryTerms", "globalTags", "domains", "institutionalMemory", "status", "structuredProperties", "forms", "testResults", "subTypes" }
