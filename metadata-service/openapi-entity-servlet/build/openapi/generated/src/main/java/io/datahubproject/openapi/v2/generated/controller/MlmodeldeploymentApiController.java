...
public class MlmodeldeploymentApiController implements MlmodeldeploymentApi {

    private static final Logger log = LoggerFactory.getLogger(MlmodeldeploymentApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.MLModelDeploymentEntityRequestV2, io.datahubproject.openapi.generated.MLModelDeploymentEntityResponseV2, io.datahubproject.openapi.generated.ScrollMLModelDeploymentEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public MlmodeldeploymentApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.MLModelDeploymentEntityRequestV2, io.datahubproject.openapi.generated.MLModelDeploymentEntityResponseV2, io.datahubproject.openapi.generated.ScrollMLModelDeploymentEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.MLModelDeploymentEntityRequestV2.class, io.datahubproject.openapi.generated.MLModelDeploymentEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollMLModelDeploymentEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<ScrollMLModelDeploymentEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "mlModelDeploymentProperties", "ownership", "status", "deprecation", "globalTags", "dataPlatformInstance", "testResults", "container" }
