...
import io.datahubproject.openapi.generated.DataHubPageTemplateEntityRequestV2;
import io.datahubproject.openapi.generated.DataHubPageTemplateEntityResponseV2;
import io.datahubproject.openapi.generated.ScrollDataHubPageTemplateEntityResponseV2;
...
public class DatahubpagetemplateApiController implements DatahubpagetemplateApi {

    private static final Logger log = LoggerFactory.getLogger(DatahubpagetemplateApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataHubPageTemplateEntityRequestV2, io.datahubproject.openapi.generated.DataHubPageTemplateEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataHubPageTemplateEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public DatahubpagetemplateApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.DataHubPageTemplateEntityRequestV2, io.datahubproject.openapi.generated.DataHubPageTemplateEntityResponseV2, io.datahubproject.openapi.generated.ScrollDataHubPageTemplateEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.DataHubPageTemplateEntityRequestV2.class, io.datahubproject.openapi.generated.DataHubPageTemplateEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollDataHubPageTemplateEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<DataHubPageTemplateEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create dataHubPageTemplate entities.", required=true, schema=@Schema()) @Valid @RequestBody List<DataHubPageTemplateEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
    ...
    @Override
    public ResponseEntity<ScrollDataHubPageTemplateEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "dataHubPageTemplateProperties" }
