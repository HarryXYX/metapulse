...
import io.datahubproject.openapi.generated.PostEntityRequestV2;
import io.datahubproject.openapi.generated.PostEntityResponseV2;
import io.datahubproject.openapi.generated.ScrollPostEntityResponseV2;
...
public class PostApiController implements PostApi {
    ...
    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.PostEntityRequestV2, io.datahubproject.openapi.generated.PostEntityResponseV2, io.datahubproject.openapi.generated.ScrollPostEntityResponseV2> delegate;
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.PostEntityRequestV2, io.datahubproject.openapi.generated.PostEntityResponseV2, io.datahubproject.openapi.generated.ScrollPostEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.PostEntityRequestV2.class, io.datahubproject.openapi.generated.PostEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollPostEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<PostEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create post entities.", required=true, schema=@Schema()) @Valid @RequestBody List<PostEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
    ...
    @Override
    public ResponseEntity<ScrollPostEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "postInfo", "subTypes" }
