...
public class BusinessattributeApiController implements BusinessattributeApi {

    private static final Logger log = LoggerFactory.getLogger(BusinessattributeApiController.class);

    private final ObjectMapper objectMapper;

    private final HttpServletRequest request;

    private final EntityApiDelegateImpl<io.datahubproject.openapi.generated.BusinessAttributeEntityRequestV2, io.datahubproject.openapi.generated.BusinessAttributeEntityResponseV2, io.datahubproject.openapi.generated.ScrollBusinessAttributeEntityResponseV2> delegate;

    @org.springframework.beans.factory.annotation.Autowired
    public BusinessattributeApiController(ObjectMapper objectMapper, HttpServletRequest request,
    ...
    SearchService searchService, EntitiesController v1Controller, AuthorizerChain authorizationChain) {
        ...
        this.delegate = new EntityApiDelegateImpl<io.datahubproject.openapi.generated.BusinessAttributeEntityRequestV2, io.datahubproject.openapi.generated.BusinessAttributeEntityResponseV2, io.datahubproject.openapi.generated.ScrollBusinessAttributeEntityResponseV2>(systemOperationContext, request, entityService, searchService, v1Controller,
        authorizationChain, io.datahubproject.openapi.generated.BusinessAttributeEntityRequestV2.class, io.datahubproject.openapi.generated.BusinessAttributeEntityResponseV2.class, io.datahubproject.openapi.generated.ScrollBusinessAttributeEntityResponseV2.class);
    }
    ...
    @Override
    public ResponseEntity<List<BusinessAttributeEntityResponseV2>> create(@Parameter(in = ParameterIn.DEFAULT, description = "Create businessAttribute entities.", required=true, schema=@Schema()) @Valid @RequestBody List<BusinessAttributeEntityRequestV2> body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity ONLY if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
    ...
    public ResponseEntity<BusinessAttributeInfoAspectResponseV2> createBusinessAttributeInfo(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn,@Parameter(in = ParameterIn.DEFAULT, description = "Create aspect businessAttributeInfo on BusinessAttribute entity.", required=true, schema=@Schema()) @Valid @RequestBody BusinessAttributeInfoAspectRequestV2 body,@Parameter(in = ParameterIn.QUERY, description = "Create the aspect if it does not already exist." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createIfNotExists", required = false, defaultValue="false") Boolean createIfNotExists,@Parameter(in = ParameterIn.QUERY, description = "Create the entity if it does not already exist. Fails in case when the entity exists." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "createEntityIfNotExists", required = false, defaultValue="false") Boolean createEntityIfNotExists) {
        return delegate.createBusinessAttributeInfo(body, urn, createIfNotExists, createEntityIfNotExists);
    }
    ...
    @Override
    public ResponseEntity<Void> deleteBusinessAttributeInfo(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.deleteBusinessAttributeInfo(urn);
    }
    ...
    @Override
    public ResponseEntity<Void> headBusinessAttributeInfo(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("urn") String urn) {
        return delegate.headBusinessAttributeInfo(urn);
    }
    ...
    @Override
    public ResponseEntity<ScrollBusinessAttributeEntityResponseV2> scroll(@Parameter(in = ParameterIn.QUERY, description = "Include systemMetadata with response." ,schema=@Schema( defaultValue="false")) @Valid @RequestParam(value = "systemMetadata", required = false, defaultValue="false") Boolean systemMetadata,@Parameter(in = ParameterIn.QUERY, description = "Aspects to include in response." ,schema=@Schema(allowableValues={ "businessAttributeInfo", "status", "ownership", "institutionalMemory" }
