...
export type Chart = BrowsableEntity &
  Entity &
  EntityWithRelationships & {
    __typename?: "Chart";
...
export type Dashboard = BrowsableEntity &
  Entity &
  EntityWithRelationships & {
 ...
 */
export type DataFlow = BrowsableEntity &
  Entity &
  EntityWithRelationships & {
    __typename?: "DataFlow";
    /** The application associated with the entity */
 ...
 */
export type DataJob = BrowsableEntity &
  Entity &
  EntityWithRelationships & {
    __typename?: "DataJob";
    /** The application associated with the entity */
 ...
 * a task or datajob.
 */
export type DataProcessInstance = Entity &
  EntityWithRelationships & {
...
export type ErModelRelationship = Entity &
  EntityWithRelationships & {
...
export type HyperParameterValueType =
  | BooleanBox
  | FloatBox
  | IntBox
  | StringBox;
...
export type MlFeatureTable = BrowsableEntity &
  Entity &
  EntityWithRelationships & {
...
export type MlModel = BrowsableEntity &
  Entity &
  EntityWithRelationships &
  SupportsVersions & {
    __typename?: "MLModel";
 ...
 */
export type MlModelGroup = BrowsableEntity &
  Entity &
  EntityWithRelationships & {
...
export type Notebook = BrowsableEntity &
  Entity & {
    __typename?: "Notebook";
    /** The application associated with the entity */
    application?: Maybe<ApplicationAssociation>;
