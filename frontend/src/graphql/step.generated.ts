...
export type BatchUpdateStepStatesMutation = { __typename?: "Mutation" } & {
  batchUpdateStepStates: { __typename?: "BatchUpdateStepStatesResult" } & {
    results: Array<
      { __typename?: "UpdateStepStateResult" } & Pick<
        Types.UpdateStepStateResult,
        "id" | "succeeded"
      >
    >;
  };
...
export function useBatchGetStepStatesQuery(
  ...
  return Apollo.useQuery<
    BatchGetStepStatesQuery,
    BatchGetStepStatesQueryVariables
  >(BatchGetStepStatesDocument, baseOptions);
}
...
export type BatchGetStepStatesQueryHookResult = ReturnType<
  typeof useBatchGetStepStatesQuery
>;
export type BatchGetStepStatesLazyQueryHookResult = ReturnType<
  typeof useBatchGetStepStatesLazyQuery
>;
...
export function useBatchUpdateStepStatesMutation(
  ...
  return Apollo.useMutation<
    BatchUpdateStepStatesMutation,
    BatchUpdateStepStatesMutationVariables
  >(BatchUpdateStepStatesDocument, baseOptions);
}
export type BatchUpdateStepStatesMutationHookResult = ReturnType<
  typeof useBatchUpdateStepStatesMutation
>;
export type BatchUpdateStepStatesMutationResult =
  Apollo.MutationResult<BatchUpdateStepStatesMutation>;
