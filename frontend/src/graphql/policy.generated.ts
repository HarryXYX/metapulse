...
export type ListPoliciesQuery = { __typename?: "Query" } & {
  listPolicies?: Types.Maybe<
    { __typename?: "ListPoliciesResult" } & Pick<
      Types.ListPoliciesResult,
      "start" | "count" | "total"
    > & {
        policies: Array<
          ...
          > & {
              ...
              actors: { __typename?: "ActorFilter" } & Pick<
                ...
                | "resourceOwnersTypes"
              > & {
                  resolvedOwnershipTypes?: Types.Maybe<
                    Array<
...
export type GetGrantedPrivilegesQuery = { __typename?: "Query" } & {
  getGrantedPrivileges?: Types.Maybe<
    { __typename?: "Privileges" } & Pick<Types.Privileges, "privileges">
  >;
};
...
export type CreatePolicyMutation = { __typename?: "Mutation" } & Pick<
  Types.Mutation,
  "createPolicy"
>;
...
export type UpdatePolicyMutation = { __typename?: "Mutation" } & Pick<
  Types.Mutation,
  "updatePolicy"
>;
...
export type DeletePolicyMutation = { __typename?: "Mutation" } & Pick<
  Types.Mutation,
  "deletePolicy"
>;
...
export function useListPoliciesQuery(
  baseOptions: Apollo.QueryHookOptions<
    ListPoliciesQuery,
    ListPoliciesQueryVariables
  >,
) {
  return Apollo.useQuery<ListPoliciesQuery, ListPoliciesQueryVariables>(
...
export function useListPoliciesLazyQuery(
  ...
  return Apollo.useLazyQuery<ListPoliciesQuery, ListPoliciesQueryVariables>(
    ListPoliciesDocument,
    baseOptions,
  );
}
export type ListPoliciesQueryHookResult = ReturnType<
  typeof useListPoliciesQuery
>;
export type ListPoliciesLazyQueryHookResult = ReturnType<
  typeof useListPoliciesLazyQuery
>;
export type ListPoliciesQueryResult = Apollo.QueryResult<
  ListPoliciesQuery,
  ListPoliciesQueryVariables
>;
...
export function useGetGrantedPrivilegesQuery(
  ...
  return Apollo.useQuery<
    GetGrantedPrivilegesQuery,
    GetGrantedPrivilegesQueryVariables
  >(GetGrantedPrivilegesDocument, baseOptions);
}
...
export type GetGrantedPrivilegesQueryHookResult = ReturnType<
  typeof useGetGrantedPrivilegesQuery
>;
export type GetGrantedPrivilegesLazyQueryHookResult = ReturnType<
  typeof useGetGrantedPrivilegesLazyQuery
>;
...
export function useCreatePolicyMutation(
  ...
  return Apollo.useMutation<
    CreatePolicyMutation,
    CreatePolicyMutationVariables
  >(CreatePolicyDocument, baseOptions);
}
export type CreatePolicyMutationHookResult = ReturnType<
  typeof useCreatePolicyMutation
>;
export type CreatePolicyMutationResult =
  Apollo.MutationResult<CreatePolicyMutation>;
...
export function useUpdatePolicyMutation(
  ...
  return Apollo.useMutation<
    UpdatePolicyMutation,
    UpdatePolicyMutationVariables
  >(UpdatePolicyDocument, baseOptions);
}
export type UpdatePolicyMutationHookResult = ReturnType<
  typeof useUpdatePolicyMutation
>;
export type UpdatePolicyMutationResult =
  Apollo.MutationResult<UpdatePolicyMutation>;
...
export function useDeletePolicyMutation(
  ...
  return Apollo.useMutation<
    DeletePolicyMutation,
    DeletePolicyMutationVariables
  >(DeletePolicyDocument, baseOptions);
}
