...
export function useGetVersionedDatasetQuery(
  ...
  return Apollo.useQuery<
    GetVersionedDatasetQuery,
    GetVersionedDatasetQueryVariables
  >(GetVersionedDatasetDocument, baseOptions);
}
...
export type GetVersionedDatasetQueryHookResult = ReturnType<
  typeof useGetVersionedDatasetQuery
>;
export type GetVersionedDatasetLazyQueryHookResult = ReturnType<
  typeof useGetVersionedDatasetLazyQuery
>;
