...
export type IsAnalyticsEnabledQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type IsAnalyticsEnabledQuery = { __typename?: "Query" } & Pick<
  Types.Query,
  "isAnalyticsEnabled"
>;

export type GetAnalyticsChartsQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetAnalyticsChartsQuery = { __typename?: "Query" } & {
  getAnalyticsCharts: Array<
    { __typename?: "AnalyticsChartGroup" } & Pick<
      Types.AnalyticsChartGroup,
      "groupId" | "title"
    > & {
        charts: Array<
...
export type AnalyticsChart_BarChart_Fragment = {
  __typename?: "BarChart";
} & Pick<Types.BarChart, "title"> & {
    bars: Array<
      { __typename?: "NamedBar" } & Pick<Types.NamedBar, "name"> & {
          segments: Array<
            { __typename?: "BarSegment" } & Pick<
              Types.BarSegment,
              "label" | "value"
            >
          >;
...
export type AnalyticsChart_TableChart_Fragment = {
  __typename?: "TableChart";
} & Pick<Types.TableChart, "title" | "columns"> & {
    rows: Array<
...
export type AnalyticsChart_TimeSeriesChart_Fragment = {
  __typename?: "TimeSeriesChart";
} & Pick<Types.TimeSeriesChart, "title" | "interval"> & {
    lines: Array<
    ...
    >;
    dateRange: { __typename?: "DateRange" } & Pick<
      Types.DateRange,
      "start" | "end"
    >;
  };
...
export function useIsAnalyticsEnabledQuery(
  ...
  return Apollo.useQuery<
    IsAnalyticsEnabledQuery,
    IsAnalyticsEnabledQueryVariables
  >(IsAnalyticsEnabledDocument, baseOptions);
}
...
export type IsAnalyticsEnabledQueryHookResult = ReturnType<
  typeof useIsAnalyticsEnabledQuery
>;
export type IsAnalyticsEnabledLazyQueryHookResult = ReturnType<
  typeof useIsAnalyticsEnabledLazyQuery
>;
...
export function useGetAnalyticsChartsQuery(
  ...
  return Apollo.useQuery<
    GetAnalyticsChartsQuery,
    GetAnalyticsChartsQueryVariables
  >(GetAnalyticsChartsDocument, baseOptions);
}
...
export type GetAnalyticsChartsQueryHookResult = ReturnType<
  typeof useGetAnalyticsChartsQuery
>;
export type GetAnalyticsChartsLazyQueryHookResult = ReturnType<
  typeof useGetAnalyticsChartsLazyQuery
>;
...
export function useGetMetadataAnalyticsChartsQuery(
  ...
  return Apollo.useQuery<
    GetMetadataAnalyticsChartsQuery,
    GetMetadataAnalyticsChartsQueryVariables
  >(GetMetadataAnalyticsChartsDocument, baseOptions);
}
...
export type GetMetadataAnalyticsChartsQueryHookResult = ReturnType<
  typeof useGetMetadataAnalyticsChartsQuery
>;
export type GetMetadataAnalyticsChartsLazyQueryHookResult = ReturnType<
  typeof useGetMetadataAnalyticsChartsLazyQuery
>;
