...
export type GetBrowseResultsV2Query = { __typename?: "Query" } & {
  browseV2?: Types.Maybe<
    { __typename?: "BrowseResultsV2" } & Pick<
      Types.BrowseResultsV2,
      "start" | "count" | "total"
    > & {
        groups: Array<
...
export function useGetBrowseResultsV2Query(
  ...
  return Apollo.useQuery<
    GetBrowseResultsV2Query,
    GetBrowseResultsV2QueryVariables
  >(GetBrowseResultsV2Document, baseOptions);
}
...
export type GetBrowseResultsV2QueryHookResult = ReturnType<
  typeof useGetBrowseResultsV2Query
>;
export type GetBrowseResultsV2LazyQueryHookResult = ReturnType<
  typeof useGetBrowseResultsV2LazyQuery
>;
