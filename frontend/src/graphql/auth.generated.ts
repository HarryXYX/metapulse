...
export type GetAccessTokenQuery = { __typename?: "Query" } & {
  getAccessToken?: Types.Maybe<
    { __typename?: "AccessToken" } & Pick<Types.AccessToken, "accessToken">
  >;
};
...
export type RevokeAccessTokenMutation = { __typename?: "Mutation" } & Pick<
  Types.Mutation,
  "revokeAccessToken"
>;
...
export function useListAccessTokensQuery(
  baseOptions: Apollo.QueryHookOptions<
    ...
    ListAccessTokensQueryVariables
  >,
) {
...
export function useListAccessTokensLazyQuery(
  ...
  return Apollo.useLazyQuery<
    ListAccessTokensQuery,
    ListAccessTokensQueryVariables
  >(ListAccessTokensDocument, baseOptions);
}
export type ListAccessTokensQueryHookResult = ReturnType<
  typeof useListAccessTokensQuery
>;
export type ListAccessTokensLazyQueryHookResult = ReturnType<
  typeof useListAccessTokensLazyQuery
>;
export type ListAccessTokensQueryResult = Apollo.QueryResult<
  ListAccessTokensQuery,
  ListAccessTokensQueryVariables
>;
...
export function useCreateAccessTokenMutation(
  ...
  return Apollo.useMutation<
    CreateAccessTokenMutation,
    CreateAccessTokenMutationVariables
  >(CreateAccessTokenDocument, baseOptions);
}
...
export function useRevokeAccessTokenMutation(
  ...
  return Apollo.useMutation<
    RevokeAccessTokenMutation,
    RevokeAccessTokenMutationVariables
  >(RevokeAccessTokenDocument, baseOptions);
}
export type RevokeAccessTokenMutationHookResult = ReturnType<
  typeof useRevokeAccessTokenMutation
>;
export type RevokeAccessTokenMutationResult =
  Apollo.MutationResult<RevokeAccessTokenMutation>;
