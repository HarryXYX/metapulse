...
export type RunResultsFragment = {
  __typename?: "DataProcessInstanceResult";
} & Pick<Types.DataProcessInstanceResult, "count" | "start" | "total"> & {
    runs?: Types.Maybe<
      Array<
        Types.Maybe<
          ...
          > & {
              ...
              inputs?: Types.Maybe<
                ...
                } & RunRelationshipResultsFragment
              >;
              outputs?: Types.Maybe<
                {
                  __typename?: "EntityRelationshipsResult";
...
export type RunRelationshipResultsFragment = {
  __typename?: "EntityRelationshipsResult";
