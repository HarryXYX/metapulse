...
export function useGetHighlightsQuery(
  ...
  return Apollo.useQuery<GetHighlightsQuery, GetHighlightsQueryVariables>(
    GetHighlightsDocument,
    baseOptions,
  );
}
export function useGetHighlightsLazyQuery(
  ...
  return Apollo.useLazyQuery<GetHighlightsQuery, GetHighlightsQueryVariables>(
    GetHighlightsDocument,
    baseOptions,
  );
}
export type GetHighlightsQueryHookResult = ReturnType<
  typeof useGetHighlightsQuery
>;
export type GetHighlightsLazyQueryHookResult = ReturnType<
  typeof useGetHighlightsLazyQuery
>;
export type GetHighlightsQueryResult = Apollo.QueryResult<
  GetHighlightsQuery,
  GetHighlightsQueryVariables
>;
