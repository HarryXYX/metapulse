...
export function useGetMlPrimaryKeyQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetMlPrimaryKeyQuery,
    GetMlPrimaryKeyQueryVariables
  >,
) {
  return Apollo.useQuery<GetMlPrimaryKeyQuery, GetMlPrimaryKeyQueryVariables>(
...
export function useGetMlPrimaryKeyLazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetMlPrimaryKeyQuery,
    GetMlPrimaryKeyQueryVariables
  >(GetMlPrimaryKeyDocument, baseOptions);
}
export type GetMlPrimaryKeyQueryHookResult = ReturnType<
  typeof useGetMlPrimaryKeyQuery
>;
export type GetMlPrimaryKeyLazyQueryHookResult = ReturnType<
  typeof useGetMlPrimaryKeyLazyQuery
>;
export type GetMlPrimaryKeyQueryResult = Apollo.QueryResult<
  GetMlPrimaryKeyQuery,
  GetMlPrimaryKeyQueryVariables
>;
