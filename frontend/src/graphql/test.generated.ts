...
> & {
    definition: { __typename?: "TestDefinition" } & Pick<
...
export type ListTestsQuery = { __typename?: "Query" } & {
  listTests?: Types.Maybe<
    { __typename?: "ListTestsResult" } & Pick<
...
export type CreateTestMutation = { __typename?: "Mutation" } & Pick<
  Types.Mutation,
  "createTest"
>;
...
export type DeleteTestMutation = { __typename?: "Mutation" } & Pick<
  Types.Mutation,
  "deleteTest"
>;
 ...
 * });
 */
export function useListTestsQuery(
  baseOptions: Apollo.QueryHookOptions<ListTestsQuery, ListTestsQueryVariables>,
) {
  return Apollo.useQuery<ListTestsQuery, ListTestsQueryVariables>(
    ListTestsDocument,
    baseOptions,
  );
}
export function useListTestsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ListTestsQuery,
    ListTestsQueryVariables
  >,
) {
  return Apollo.useLazyQuery<ListTestsQuery, ListTestsQueryVariables>(
    ListTestsDocument,
    baseOptions,
  );
}
export type ListTestsQueryHookResult = ReturnType<typeof useListTestsQuery>;
export type ListTestsLazyQueryHookResult = ReturnType<
  typeof useListTestsLazyQuery
>;
export type ListTestsQueryResult = Apollo.QueryResult<
  ListTestsQuery,
  ListTestsQueryVariables
>;
