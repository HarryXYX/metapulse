  ...
  getSchemaBlame?: Types.Maybe<
    { __typename?: "GetSchemaBlameResult" } & {
      ...
      schemaFieldBlameList?: Types.Maybe<
        Array<
          { __typename?: "SchemaFieldBlame" } & Pick<
            Types.SchemaFieldBlame,
            "fieldPath"
          > & {
...
export function useGetSchemaBlameQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetSchemaBlameQuery,
    GetSchemaBlameQueryVariables
  >,
) {
  return Apollo.useQuery<GetSchemaBlameQuery, GetSchemaBlameQueryVariables>(
    GetSchemaBlameDocument,
    baseOptions,
  );
}
export function useGetSchemaBlameLazyQuery(
  ...
  return Apollo.useLazyQuery<GetSchemaBlameQuery, GetSchemaBlameQueryVariables>(
    GetSchemaBlameDocument,
    baseOptions,
  );
}
export type GetSchemaBlameQueryHookResult = ReturnType<
  typeof useGetSchemaBlameQuery
>;
export type GetSchemaBlameLazyQueryHookResult = ReturnType<
  typeof useGetSchemaBlameLazyQuery
>;
export type GetSchemaBlameQueryResult = Apollo.QueryResult<
  GetSchemaBlameQuery,
  GetSchemaBlameQueryVariables
>;
...
export function useGetSchemaVersionListQuery(
  ...
  return Apollo.useQuery<
    GetSchemaVersionListQuery,
    GetSchemaVersionListQueryVariables
  >(GetSchemaVersionListDocument, baseOptions);
}
...
export type GetSchemaVersionListQueryHookResult = ReturnType<
  typeof useGetSchemaVersionListQuery
>;
export type GetSchemaVersionListLazyQueryHookResult = ReturnType<
  typeof useGetSchemaVersionListLazyQuery
>;
