 ...
 *
 * <p>Configures CORS to allow frontend (localhost:3000) to communicate with backend
 * (localhost:8080)
 */
@Configuration
public class WebSecurityConfig {
   ...
   *
   * <p>Development: Allows localhost:3000 (Vite dev server) Production: Should be configured via
