...
import com.linkedin.metadata.aspect.MLModelGroupAspectArray;
    ...
    extends RecordTemplate
{
    ...
    public MLModelGroupSnapshot(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static MLModelGroupSnapshot.Fields fields() {
        return _fields;
    }

    public static MLModelGroupSnapshot.ProjectionMask createMask() {
        return new MLModelGroupSnapshot.ProjectionMask();
    }
     ...
     * 
     * @see MLModelGroupSnapshot.Fields#urn
     */
     ...
     * @see MLModelGroupSnapshot.Fields#urn
     */
    public MLModelGroupSnapshot setUrn(
        @Nullable
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field urn of com.linkedin.metadata.snapshot.MLModelGroupSnapshot");
                } else {
    ...
    public MLModelGroupSnapshot setUrn(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field urn of com.linkedin.metadata.snapshot.MLModelGroupSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.Urn.class));
            _urnField = value;
        }
     ...
     * 
     * @see MLModelGroupSnapshot.Fields#aspects
     */
     ...
     */
    @Nullable
    public MLModelGroupAspectArray getAspects(GetMode mode) {
        switch (mode) {
            case STRICT:
                return getAspects();
            case DEFAULT:
            case NULL:
                if (_aspectsField!= null) {
                    ...
                    _aspectsField = ((__rawValue == null)?null:new MLModelGroupAspectArray(DataTemplateUtil.castOrThrow(__rawValue, DataList.class)));
                    return _aspectsField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
     ...
     */
    @Nonnull
    public MLModelGroupAspectArray getAspects() {
        if (_aspectsField!= null) {
            return _aspectsField;
        } else {
            Object __rawValue = super._map.get("aspects");
     ...
     * @see MLModelGroupSnapshot.Fields#aspects
     */
    public MLModelGroupSnapshot setAspects(
        @Nullable
        MLModelGroupAspectArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setAspects(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field aspects of com.linkedin.metadata.snapshot.MLModelGroupSnapshot");
                } else {
    ...
    public MLModelGroupSnapshot setAspects(
        @Nonnull
        MLModelGroupAspectArray value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field aspects of com.linkedin.metadata.snapshot.MLModelGroupSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "aspects", value.data());
            _aspectsField = value;
        }
    ...
    @Override
    public MLModelGroupSnapshot clone()
        throws CloneNotSupportedException
    {
        MLModelGroupSnapshot __clone = ((MLModelGroupSnapshot) super.clone());
        __clone.__changeListener = new MLModelGroupSnapshot.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public MLModelGroupSnapshot copy()
        throws CloneNotSupportedException
    {
        MLModelGroupSnapshot __copy = ((MLModelGroupSnapshot) super.copy());
        __copy._urnField = null;
        __copy._aspectsField = null;
        __copy.__changeListener = new MLModelGroupSnapshot.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final MLModelGroupSnapshot __objectRef;

        private ChangeListener(MLModelGroupSnapshot reference) {
        ...
        extends PathSpec
    {
         ...
         * 
         */
        public com.linkedin.metadata.aspect.MLModelGroupAspectArray.Fields aspects() {
            return new com.linkedin.metadata.aspect.MLModelGroupAspectArray.Fields(getPathComponents(), "aspects");
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.MLModelGroupAspectArray.ProjectionMask _aspectsMask;
         ...
         * 
         */
        public MLModelGroupSnapshot.ProjectionMask withUrn() {
         ...
         * 
         */
        public MLModelGroupSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.MLModelGroupAspectArray.ProjectionMask, com.linkedin.metadata.aspect.MLModelGroupAspectArray.ProjectionMask> nestedMask) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?MLModelGroupAspectArray.createMask():_aspectsMask));
         ...
         * 
         */
        public MLModelGroupSnapshot.ProjectionMask withAspects() {
            _aspectsMask = null;
         ...
         * 
         */
        public MLModelGroupSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.MLModelGroupAspectArray.ProjectionMask, com.linkedin.metadata.aspect.MLModelGroupAspectArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?MLModelGroupAspectArray.createMask():_aspectsMask));
            getDataMap().put("aspects", _aspectsMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public MLModelGroupSnapshot.ProjectionMask withAspects(Integer start, Integer count) {
            _aspectsMask = null;
