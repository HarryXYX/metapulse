    ...
    extends WrappingArrayTemplate<DataProductAssociation>
{
    ...
    public static DataProductAssociationArray.ProjectionMask createMask() {
        return new DataProductAssociationArray.ProjectionMask();
    }

    @Override
    public DataProductAssociationArray clone()
    ...
    @Override
    public DataProductAssociationArray copy()
        throws CloneNotSupportedException
    {
    ...
    @Override
    protected DataProductAssociation coerceOutput(Object object)
        ...
        extends PathSpec
    {
        ...
        public com.linkedin.dataproduct.DataProductAssociation.Fields items() {
            return new com.linkedin.dataproduct.DataProductAssociation.Fields(getPathComponents(), PathSpec.WILDCARD);
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.dataproduct.DataProductAssociation.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public DataProductAssociationArray.ProjectionMask withItems(Function<com.linkedin.dataproduct.DataProductAssociation.ProjectionMask, com.linkedin.dataproduct.DataProductAssociation.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?DataProductAssociation.createMask():_itemsMask));
