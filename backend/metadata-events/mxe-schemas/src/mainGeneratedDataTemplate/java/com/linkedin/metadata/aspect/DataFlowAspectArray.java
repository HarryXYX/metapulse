    ...
    extends WrappingArrayTemplate<DataFlowAspect>
{
    ...
    public static DataFlowAspectArray.ProjectionMask createMask() {
        return new DataFlowAspectArray.ProjectionMask();
    }

    @Override
    public DataFlowAspectArray clone()
        throws CloneNotSupportedException
    {
        DataFlowAspectArray __clone = ((DataFlowAspectArray) super.clone());
        return __clone;
    }

    @Override
    public DataFlowAspectArray copy()
        throws CloneNotSupportedException
    {
        DataFlowAspectArray __copy = ((DataFlowAspectArray) super.copy());
        return __copy;
    }

    @Override
    protected DataFlowAspect coerceOutput(Object object)
        throws TemplateOutputCastException
    {
        assert(object != null);
        return ((object == null)?null:new DataFlowAspect(object));
    }
        ...
        extends PathSpec
    {
        ...
        public com.linkedin.metadata.aspect.DataFlowAspect.Fields items() {
            return new com.linkedin.metadata.aspect.DataFlowAspect.Fields(getPathComponents(), PathSpec.WILDCARD);
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.DataFlowAspect.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public DataFlowAspectArray.ProjectionMask withItems(Function<com.linkedin.metadata.aspect.DataFlowAspect.ProjectionMask, com.linkedin.metadata.aspect.DataFlowAspect.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?DataFlowAspect.createMask():_itemsMask));
