    ...
    extends WrappingArrayTemplate<MLHyperParam>
{
    ...
    public static MLHyperParamArray.ProjectionMask createMask() {
        return new MLHyperParamArray.ProjectionMask();
    }
    ...
    {
        MLHyperParamArray __clone = ((MLHyperParamArray) super.clone());
        return __clone;
    }
    ...
    public MLHyperParamArray copy()
        throws CloneNotSupportedException
    {
        MLHyperParamArray __copy = ((MLHyperParamArray) super.copy());
        return __copy;
    }

    @Override
    protected MLHyperParam coerceOutput(Object object)
        throws TemplateOutputCastException
    {
        assert(object != null);
        return ((object == null)?null:new MLHyperParam(DataTemplateUtil.castOrThrow(object, DataMap.class)));
    }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.ml.metadata.MLHyperParam.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public MLHyperParamArray.ProjectionMask withItems(Function<com.linkedin.ml.metadata.MLHyperParam.ProjectionMask, com.linkedin.ml.metadata.MLHyperParam.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?MLHyperParam.createMask():_itemsMask));
