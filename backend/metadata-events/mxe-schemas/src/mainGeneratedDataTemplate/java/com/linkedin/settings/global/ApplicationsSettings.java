 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-events/mxe-schemas/src/main/pegasus/com/linkedin/settings/global/ApplicationsSettings.pdl.")
public class ApplicationsSettings
    extends RecordTemplate
{

    private final static ApplicationsSettings.Fields _fields = new ApplicationsSettings.Fields();
    private final static RecordDataSchema SCHEMA = ((RecordDataSchema) DataTemplateUtil.parseSchema("namespace com.linkedin.settings.global,record ApplicationsSettings includes/**A standardized settings template for a feature.*/record FeatureSettings{enabled:boolean/**The configuration for the feature, in JSON format.*/config:optional string/**The version of the configuration schema that has been used to serialize\n       the config.\nIf not provided, the version is assumed to be the latest version.*/configVersion:optional string}{}", SchemaFormatType.PDL));
    private Boolean _enabledField = null;
    private String _configField = null;
    private String _configVersionField = null;
    private ApplicationsSettings.ChangeListener __changeListener = new ApplicationsSettings.ChangeListener(this);
    ...
    public ApplicationsSettings(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static ApplicationsSettings.Fields fields() {
        return _fields;
    }

    public static ApplicationsSettings.ProjectionMask createMask() {
        return new ApplicationsSettings.ProjectionMask();
    }
     ...
     * 
     * @see ApplicationsSettings.Fields#enabled
     */
     ...
     * @see ApplicationsSettings.Fields#enabled
     */
    public ApplicationsSettings setEnabled(
        @Nullable
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field enabled of com.linkedin.settings.global.ApplicationsSettings");
                } else {
    ...
    public ApplicationsSettings setEnabled(
        ...
        Boolean value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field enabled of com.linkedin.settings.global.ApplicationsSettings to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "enabled", value);
            _enabledField = value;
        }
     ...
     * @see ApplicationsSettings.Fields#enabled
     */
    public ApplicationsSettings setEnabled(boolean value) {
        CheckedUtil.putWithoutChecking(super._map, "enabled", value);
        _enabledField = value;
        return this;
    }
     ...
     * 
     * @see ApplicationsSettings.Fields#config
     */
     ...
     * @see ApplicationsSettings.Fields#config
     */
    public ApplicationsSettings setConfig(
        @Nullable
    ...
    public ApplicationsSettings setConfig(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field config of com.linkedin.settings.global.ApplicationsSettings to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "config", value);
            _configField = value;
        }
     ...
     * 
     * @see ApplicationsSettings.Fields#configVersion
     */
     ...
     * @see ApplicationsSettings.Fields#configVersion
     */
    public ApplicationsSettings setConfigVersion(
        @Nullable
        String value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
    ...
    public ApplicationsSettings setConfigVersion(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field configVersion of com.linkedin.settings.global.ApplicationsSettings to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "configVersion", value);
            _configVersionField = value;
        }
    ...
    @Override
    public ApplicationsSettings clone()
        throws CloneNotSupportedException
    {
        ApplicationsSettings __clone = ((ApplicationsSettings) super.clone());
        __clone.__changeListener = new ApplicationsSettings.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public ApplicationsSettings copy()
        throws CloneNotSupportedException
    {
        ApplicationsSettings __copy = ((ApplicationsSettings) super.copy());
        __copy._configVersionField = null;
        __copy._configField = null;
        __copy._enabledField = null;
        __copy.__changeListener = new ApplicationsSettings.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final ApplicationsSettings __objectRef;

        private ChangeListener(ApplicationsSettings reference) {
        ...
        extends MaskMap
    {
        ...
        public ApplicationsSettings.ProjectionMask withEnabled() {
         ...
         * 
         */
        public ApplicationsSettings.ProjectionMask withConfig() {
         ...
         * 
         */
        public ApplicationsSettings.ProjectionMask withConfigVersion() {
