...
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-events/mxe-schemas/src/main/pegasus/com/linkedin/metadata/query/BrowseResult.pdl.")
public class BrowseResultEntityArray
    extends WrappingArrayTemplate<BrowseResultEntity>
{

    private final static ArrayDataSchema SCHEMA = ((ArrayDataSchema) DataTemplateUtil.parseSchema("array[{namespace com.linkedin.metadata.query/**Data model for an entity returned as part of a browse query*/record BrowseResultEntity{/**Name of the entity*/name:optional string/**URN of the entity*/urn:{namespace com.linkedin.common@java.class=\"com.linkedin.common.urn.Urn\"typeref Urn=string}}}]", SchemaFormatType.PDL));
        ...
        extends PathSpec
    {
        ...
        public com.linkedin.metadata.query.BrowseResultEntity.Fields items() {
            return new com.linkedin.metadata.query.BrowseResultEntity.Fields(getPathComponents(), PathSpec.WILDCARD);
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.query.BrowseResultEntity.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public BrowseResultEntityArray.ProjectionMask withItems(Function<com.linkedin.metadata.query.BrowseResultEntity.ProjectionMask, com.linkedin.metadata.query.BrowseResultEntity.ProjectionMask> nestedMask) {
