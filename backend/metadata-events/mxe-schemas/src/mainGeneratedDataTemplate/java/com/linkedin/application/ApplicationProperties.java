 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-events/mxe-schemas/src/main/pegasus/com/linkedin/application/ApplicationProperties.pdl.")
public class ApplicationProperties
    extends RecordTemplate
{

    private final static ApplicationProperties.Fields _fields = new ApplicationProperties.Fields();
    private final static RecordDataSchema SCHEMA = ((RecordDataSchema) DataTemplateUtil.parseSchema("namespace com.linkedin.application/**The main properties of an Application*/@Aspect.name=\"applicationProperties\"record ApplicationProperties includes{namespace com.linkedin.common/**Misc. properties about an entity.*/record CustomProperties{/**Custom property bag.*/@Searchable.`/*`={\"fieldType\":\"TEXT\",\"queryByDefault\":true}customProperties:map[string,string]={}}}{namespace com.linkedin.common/**A reference to an external platform.*/record ExternalReference{/**URL where the reference exist*/@Searchable.fieldType=\"KEYWORD\"externalUrl:optional@java={\"class\":\"com.linkedin.common.url.Url\",\"coercerClass\":\"com.linkedin.common.url.UrlCoercer\"}typeref Url=string}}{/**Display name of the Application*/@Searchable={\"boostScore\":10.0,\"enableAutocomplete\":true,\"fieldNameAliases\":[\"_entityName\"],\"fieldType\":\"WORD_GRAM\",\"searchLabel\":\"entityName\",\"searchTier\":1}name:optional string/**Documentation of the application*/@Searchable={\"fieldType\":\"TEXT\",\"hasValuesFieldName\":\"hasDescription\",\"searchTier\":2}description:optional string}", SchemaFormatType.PDL));
    private StringMap _customPropertiesField = null;
    private com.linkedin.common.url.Url _externalUrlField = null;
    private String _nameField = null;
    private String _descriptionField = null;
    private ApplicationProperties.ChangeListener __changeListener = new ApplicationProperties.ChangeListener(this);
    ...
    public ApplicationProperties(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static ApplicationProperties.Fields fields() {
        return _fields;
    }

    public static ApplicationProperties.ProjectionMask createMask() {
        return new ApplicationProperties.ProjectionMask();
    }
     ...
     * 
     * @see ApplicationProperties.Fields#customProperties
     */
     ...
     * @see ApplicationProperties.Fields#customProperties
     */
    public ApplicationProperties setCustomProperties(
        @Nullable
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field customProperties of com.linkedin.application.ApplicationProperties");
                } else {
    ...
    public ApplicationProperties setCustomProperties(
        ...
        StringMap value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field customProperties of com.linkedin.application.ApplicationProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "customProperties", value.data());
            _customPropertiesField = value;
        }
     ...
     * 
     * @see ApplicationProperties.Fields#externalUrl
     */
     ...
     * @see ApplicationProperties.Fields#externalUrl
     */
    public ApplicationProperties setExternalUrl(
        @Nullable
    ...
    public ApplicationProperties setExternalUrl(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field externalUrl of com.linkedin.application.ApplicationProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "externalUrl", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.url.Url.class));
            _externalUrlField = value;
        }
     ...
     * 
     * @see ApplicationProperties.Fields#name
     */
     ...
     * @see ApplicationProperties.Fields#name
     */
    public ApplicationProperties setName(
        @Nullable
    ...
    public ApplicationProperties setName(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field name of com.linkedin.application.ApplicationProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "name", value);
            _nameField = value;
        }
     ...
     * 
     * @see ApplicationProperties.Fields#description
     */
     ...
     * @see ApplicationProperties.Fields#description
     */
    public ApplicationProperties setDescription(
        @Nullable
        String value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
    ...
    public ApplicationProperties setDescription(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field description of com.linkedin.application.ApplicationProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "description", value);
            _descriptionField = value;
        }
    ...
    {
        ApplicationProperties __clone = ((ApplicationProperties) super.clone());
        __clone.__changeListener = new ApplicationProperties.ChangeListener(__clone);
    ...
    public ApplicationProperties copy()
        throws CloneNotSupportedException
    {
        ApplicationProperties __copy = ((ApplicationProperties) super.copy());
        __copy._externalUrlField = null;
        __copy._customPropertiesField = null;
        __copy._nameField = null;
        __copy._descriptionField = null;
        __copy.__changeListener = new ApplicationProperties.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final ApplicationProperties __objectRef;

        private ChangeListener(ApplicationProperties reference) {
        ...
        extends MaskMap
    {
         ...
         * 
         */
        public ApplicationProperties.ProjectionMask withCustomProperties() {
         ...
         * 
         */
        public ApplicationProperties.ProjectionMask withExternalUrl() {
         ...
         * 
         */
        public ApplicationProperties.ProjectionMask withName() {
         ...
         * 
         */
        public ApplicationProperties.ProjectionMask withDescription() {
