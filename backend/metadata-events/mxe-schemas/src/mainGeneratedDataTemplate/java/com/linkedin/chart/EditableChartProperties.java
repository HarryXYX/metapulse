    ...
    extends RecordTemplate
{
    ...
    private EditableChartProperties.ChangeListener __changeListener = new EditableChartProperties.ChangeListener(this);
    ...
    public EditableChartProperties(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static EditableChartProperties.Fields fields() {
        return _fields;
    }

    public static EditableChartProperties.ProjectionMask createMask() {
        return new EditableChartProperties.ProjectionMask();
    }
     ...
     * 
     * @see EditableChartProperties.Fields#created
     */
     ...
     * @see EditableChartProperties.Fields#created
     */
    public EditableChartProperties setCreated(
        @Nullable
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field created of com.linkedin.chart.EditableChartProperties");
                } else {
    ...
    public EditableChartProperties setCreated(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field created of com.linkedin.chart.EditableChartProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "created", value.data());
            _createdField = value;
        }
     ...
     * 
     * @see EditableChartProperties.Fields#lastModified
     */
     ...
     * @see EditableChartProperties.Fields#lastModified
     */
    public EditableChartProperties setLastModified(
        @Nullable
        AuditStamp value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field lastModified of com.linkedin.chart.EditableChartProperties");
                } else {
    ...
    public EditableChartProperties setLastModified(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field lastModified of com.linkedin.chart.EditableChartProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "lastModified", value.data());
            _lastModifiedField = value;
        }
     ...
     * 
     * @see EditableChartProperties.Fields#deleted
     */
     ...
     * @see EditableChartProperties.Fields#deleted
     */
    public EditableChartProperties setDeleted(
        @Nullable
        AuditStamp value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
    ...
    public EditableChartProperties setDeleted(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field deleted of com.linkedin.chart.EditableChartProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "deleted", value.data());
            _deletedField = value;
        }
     ...
     * 
     * @see EditableChartProperties.Fields#description
     */
     ...
     * @see EditableChartProperties.Fields#description
     */
    public EditableChartProperties setDescription(
        @Nullable
    ...
    public EditableChartProperties setDescription(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field description of com.linkedin.chart.EditableChartProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "description", value);
            _descriptionField = value;
        }
    ...
    @Override
    public EditableChartProperties clone()
        throws CloneNotSupportedException
    {
        EditableChartProperties __clone = ((EditableChartProperties) super.clone());
        __clone.__changeListener = new EditableChartProperties.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public EditableChartProperties copy()
        throws CloneNotSupportedException
    {
        EditableChartProperties __copy = ((EditableChartProperties) super.copy());
        __copy._deletedField = null;
        __copy._createdField = null;
        __copy._descriptionField = null;
        __copy._lastModifiedField = null;
        __copy.__changeListener = new EditableChartProperties.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final EditableChartProperties __objectRef;

        private ChangeListener(EditableChartProperties reference) {
        ...
        extends MaskMap
    {
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withCreated(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withCreated(MaskMap nestedMask) {
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withCreated() {
            _createdMask = null;
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withLastModified(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withLastModified(MaskMap nestedMask) {
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withLastModified() {
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withDeleted(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withDeleted(MaskMap nestedMask) {
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withDeleted() {
            _deletedMask = null;
         ...
         * 
         */
        public EditableChartProperties.ProjectionMask withDescription() {
