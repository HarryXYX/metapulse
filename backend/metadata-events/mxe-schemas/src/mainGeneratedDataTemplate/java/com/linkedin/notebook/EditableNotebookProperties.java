    ...
    extends RecordTemplate
{
    ...
    private EditableNotebookProperties.ChangeListener __changeListener = new EditableNotebookProperties.ChangeListener(this);
    ...
    public EditableNotebookProperties(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static EditableNotebookProperties.Fields fields() {
        return _fields;
    }

    public static EditableNotebookProperties.ProjectionMask createMask() {
        return new EditableNotebookProperties.ProjectionMask();
    }
     ...
     * 
     * @see EditableNotebookProperties.Fields#created
     */
     ...
     * @see EditableNotebookProperties.Fields#created
     */
    public EditableNotebookProperties setCreated(
        @Nullable
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field created of com.linkedin.notebook.EditableNotebookProperties");
                } else {
    ...
    public EditableNotebookProperties setCreated(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field created of com.linkedin.notebook.EditableNotebookProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "created", value.data());
            _createdField = value;
        }
     ...
     * 
     * @see EditableNotebookProperties.Fields#lastModified
     */
     ...
     * @see EditableNotebookProperties.Fields#lastModified
     */
    public EditableNotebookProperties setLastModified(
        @Nullable
        AuditStamp value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field lastModified of com.linkedin.notebook.EditableNotebookProperties");
                } else {
    ...
    public EditableNotebookProperties setLastModified(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field lastModified of com.linkedin.notebook.EditableNotebookProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "lastModified", value.data());
            _lastModifiedField = value;
        }
     ...
     * 
     * @see EditableNotebookProperties.Fields#deleted
     */
     ...
     * @see EditableNotebookProperties.Fields#deleted
     */
    public EditableNotebookProperties setDeleted(
        @Nullable
        AuditStamp value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
    ...
    public EditableNotebookProperties setDeleted(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field deleted of com.linkedin.notebook.EditableNotebookProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "deleted", value.data());
            _deletedField = value;
        }
     ...
     * 
     * @see EditableNotebookProperties.Fields#description
     */
     ...
     * @see EditableNotebookProperties.Fields#description
     */
    public EditableNotebookProperties setDescription(
        @Nullable
    ...
    public EditableNotebookProperties setDescription(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field description of com.linkedin.notebook.EditableNotebookProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "description", value);
            _descriptionField = value;
        }
    ...
    @Override
    public EditableNotebookProperties clone()
        throws CloneNotSupportedException
    {
        EditableNotebookProperties __clone = ((EditableNotebookProperties) super.clone());
        __clone.__changeListener = new EditableNotebookProperties.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public EditableNotebookProperties copy()
        throws CloneNotSupportedException
    {
        EditableNotebookProperties __copy = ((EditableNotebookProperties) super.copy());
        __copy._deletedField = null;
        __copy._createdField = null;
        __copy._descriptionField = null;
        __copy._lastModifiedField = null;
        __copy.__changeListener = new EditableNotebookProperties.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final EditableNotebookProperties __objectRef;

        private ChangeListener(EditableNotebookProperties reference) {
        ...
        extends MaskMap
    {
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withCreated(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withCreated(MaskMap nestedMask) {
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withCreated() {
            _createdMask = null;
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withLastModified(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withLastModified(MaskMap nestedMask) {
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withLastModified() {
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withDeleted(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withDeleted(MaskMap nestedMask) {
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withDeleted() {
            _deletedMask = null;
         ...
         * 
         */
        public EditableNotebookProperties.ProjectionMask withDescription() {
