    ...
    extends DirectArrayTemplate<com.linkedin.common.urn.DataJobUrn>
{
    ...
    @Override
    protected Object coerceInput(com.linkedin.common.urn.DataJobUrn object)
        throws ClassCastException
    {
        ArgumentUtil.notNull(object, "object");
        return DataTemplateUtil.coerceCustomInput(object, com.linkedin.common.urn.DataJobUrn.class);
    }

    @Override
    protected com.linkedin.common.urn.DataJobUrn coerceOutput(Object object)
        throws TemplateOutputCastException
    {
        assert(object != null);
        return DataTemplateUtil.coerceCustomOutput(object, com.linkedin.common.urn.DataJobUrn.class);
    }
