 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-events/mxe-schemas/src/main/pegasus/com/linkedin/ermodelrelation/EditableERModelRelationshipProperties.pdl.")
public class EditableERModelRelationshipProperties
    extends RecordTemplate
{

    private final static EditableERModelRelationshipProperties.Fields _fields = new EditableERModelRelationshipProperties.Fields();
    private final static RecordDataSchema SCHEMA = ((RecordDataSchema) DataTemplateUtil.parseSchema("namespace com.linkedin.ermodelrelation/**EditableERModelRelationProperties stores editable changes made to erModelRelationship properties. This separates changes made from\ningestion pipelines and edits in the UI to avoid accidental overwrites of user-provided data by ingestion pipelines*/@Aspect.name=\"editableERModelRelationshipProperties\"record EditableERModelRelationshipProperties includes{namespace com.linkedin.common/**Data captured on a resource/association/sub-resource level giving insight into when that resource/association/sub-resource moved into various lifecycle stages, and who acted to move it into those lifecycle stages. The recommended best practice is to include this record in your record schema, and annotate its fields as @readOnly in your resource. See https://github.com/linkedin/rest.li/wiki/Validation-in-Rest.li#restli-validation-annotations*/record ChangeAuditStamps{/**An AuditStamp corresponding to the creation of this resource/association/sub-resource. A value of 0 for time indicates missing data.*/created:/**Data captured on a resource/association/sub-resource level giving insight into when that resource/association/sub-resource moved into a particular lifecycle stage, and who acted to move it into that specific lifecycle stage.*/record AuditStamp{/**When did the resource/association/sub-resource move into the specific lifecycle stage represented by this AuditEvent.*/time:/**Number of milliseconds since midnight, January 1, 1970 UTC. It must be a positive number*/typeref Time=long/**The entity (e.g. a member URN) which will be credited for moving the resource/association/sub-resource into the specific lifecycle stage. It is also the one used to authorize the change.*/actor:@java.class=\"com.linkedin.common.urn.Urn\"typeref Urn=string/**The entity (e.g. a service URN) which performs the change on behalf of the Actor and must be authorized to act as the Actor.*/impersonator:optional Urn/**Additional context around how DataHub was informed of the particular change. For example: was the change created by an automated process, or manually.*/message:optional string}={\"time\":0,\"actor\":\"urn:li:corpuser:unknown\"}/**An AuditStamp corresponding to the last modification of this resource/association/sub-resource. If no modification has happened since creation, lastModified should be the same as created. A value of 0 for time indicates missing data.*/lastModified:AuditStamp={\"time\":0,\"actor\":\"urn:li:corpuser:unknown\"}/**An AuditStamp corresponding to the deletion of this resource/association/sub-resource. Logically, deleted MUST have a later timestamp than creation. It may or may not have the same time as lastModified depending upon the resource/association/sub-resource semantics.*/deleted:optional AuditStamp}}{/**Documentation of the erModelRelationship*/@Searchable={\"fieldName\":\"editedDescription\",\"fieldType\":\"TEXT\",\"searchTier\":2}description:optional string/**Display name of the ERModelRelation*/@Searchable={\"fieldName\":\"editedName\",\"fieldType\":\"TEXT_PARTIAL\"}name:optional string}", SchemaFormatType.PDL));
    ...
    private EditableERModelRelationshipProperties.ChangeListener __changeListener = new EditableERModelRelationshipProperties.ChangeListener(this);
    ...
    public EditableERModelRelationshipProperties() {
        super(new DataMap(7, 0.75F), SCHEMA, 4);
        addChangeListener(__changeListener);
    }

    public EditableERModelRelationshipProperties(DataMap data) {
        super(data, SCHEMA);
        addChangeListener(__changeListener);
    }

    public static EditableERModelRelationshipProperties.Fields fields() {
        return _fields;
    }

    public static EditableERModelRelationshipProperties.ProjectionMask createMask() {
        return new EditableERModelRelationshipProperties.ProjectionMask();
    }
     ...
     * 
     * @see EditableERModelRelationshipProperties.Fields#created
     */
     ...
     * @see EditableERModelRelationshipProperties.Fields#created
     */
    public EditableERModelRelationshipProperties setCreated(
        @Nullable
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field created of com.linkedin.ermodelrelation.EditableERModelRelationshipProperties");
                } else {
    ...
    public EditableERModelRelationshipProperties setCreated(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field created of com.linkedin.ermodelrelation.EditableERModelRelationshipProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "created", value.data());
            _createdField = value;
        }
     ...
     * 
     * @see EditableERModelRelationshipProperties.Fields#lastModified
     */
     ...
     * @see EditableERModelRelationshipProperties.Fields#lastModified
     */
    public EditableERModelRelationshipProperties setLastModified(
        @Nullable
        AuditStamp value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field lastModified of com.linkedin.ermodelrelation.EditableERModelRelationshipProperties");
                } else {
    ...
    public EditableERModelRelationshipProperties setLastModified(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field lastModified of com.linkedin.ermodelrelation.EditableERModelRelationshipProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "lastModified", value.data());
            _lastModifiedField = value;
        }
     ...
     * 
     * @see EditableERModelRelationshipProperties.Fields#deleted
     */
     ...
     * @see EditableERModelRelationshipProperties.Fields#deleted
     */
    public EditableERModelRelationshipProperties setDeleted(
        @Nullable
        AuditStamp value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
    ...
    public EditableERModelRelationshipProperties setDeleted(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field deleted of com.linkedin.ermodelrelation.EditableERModelRelationshipProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "deleted", value.data());
            _deletedField = value;
        }
     ...
     * 
     * @see EditableERModelRelationshipProperties.Fields#description
     */
     ...
     * @see EditableERModelRelationshipProperties.Fields#description
     */
    public EditableERModelRelationshipProperties setDescription(
        @Nullable
    ...
    public EditableERModelRelationshipProperties setDescription(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field description of com.linkedin.ermodelrelation.EditableERModelRelationshipProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "description", value);
            _descriptionField = value;
        }
     ...
     * 
     * @see EditableERModelRelationshipProperties.Fields#name
     */
     ...
     * @see EditableERModelRelationshipProperties.Fields#name
     */
    public EditableERModelRelationshipProperties setName(
        @Nullable
        String value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
    ...
    public EditableERModelRelationshipProperties setName(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field name of com.linkedin.ermodelrelation.EditableERModelRelationshipProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "name", value);
            _nameField = value;
        }
    ...
    @Override
    public EditableERModelRelationshipProperties clone()
        throws CloneNotSupportedException
    {
        EditableERModelRelationshipProperties __clone = ((EditableERModelRelationshipProperties) super.clone());
        __clone.__changeListener = new EditableERModelRelationshipProperties.ChangeListener(__clone);
        __clone.addChangeListener(__clone.__changeListener);
        return __clone;
    }

    @Override
    public EditableERModelRelationshipProperties copy()
        throws CloneNotSupportedException
    {
        EditableERModelRelationshipProperties __copy = ((EditableERModelRelationshipProperties) super.copy());
        __copy._deletedField = null;
        __copy._createdField = null;
        __copy._nameField = null;
        __copy._descriptionField = null;
        __copy._lastModifiedField = null;
        __copy.__changeListener = new EditableERModelRelationshipProperties.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final EditableERModelRelationshipProperties __objectRef;

        private ChangeListener(EditableERModelRelationshipProperties reference) {
        ...
        extends MaskMap
    {
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withCreated(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withCreated(MaskMap nestedMask) {
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withCreated() {
            _createdMask = null;
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withLastModified(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withLastModified(MaskMap nestedMask) {
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withLastModified() {
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withDeleted(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withDeleted(MaskMap nestedMask) {
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withDeleted() {
            _deletedMask = null;
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withDescription() {
         ...
         * 
         */
        public EditableERModelRelationshipProperties.ProjectionMask withName() {
