 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/schema/StringType.pdl.")
    ...
    extends RecordTemplate
{
    ...
    public static StringType.ProjectionMask createMask() {
        return new StringType.ProjectionMask();
    }
    ...
    {
        StringType __clone = ((StringType) super.clone());
        return __clone;
    }
    ...
    public StringType copy()
        throws CloneNotSupportedException
    {
        StringType __copy = ((StringType) super.copy());
        return __copy;
    }
