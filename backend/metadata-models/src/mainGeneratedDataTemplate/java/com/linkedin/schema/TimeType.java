 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/schema/TimeType.pdl.")
    ...
    extends RecordTemplate
{
    ...
    public static TimeType.ProjectionMask createMask() {
        return new TimeType.ProjectionMask();
    }
    ...
    {
        TimeType __clone = ((TimeType) super.clone());
        return __clone;
    }
    ...
    public TimeType copy()
        throws CloneNotSupportedException
    {
        TimeType __copy = ((TimeType) super.copy());
        return __copy;
    }
