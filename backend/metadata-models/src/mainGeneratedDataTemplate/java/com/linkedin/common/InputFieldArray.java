    ...
    extends WrappingArrayTemplate<InputField>
{
    ...
    public static InputFieldArray.ProjectionMask createMask() {
        return new InputFieldArray.ProjectionMask();
    }

    @Override
    public InputFieldArray clone()
        throws CloneNotSupportedException
    {
        InputFieldArray __clone = ((InputFieldArray) super.clone());
        return __clone;
    }

    @Override
    public InputFieldArray copy()
        throws CloneNotSupportedException
    {
        InputFieldArray __copy = ((InputFieldArray) super.copy());
        return __copy;
    }

    @Override
    protected InputField coerceOutput(Object object)
        throws TemplateOutputCastException
    {
        assert(object != null);
        return ((object == null)?null:new InputField(DataTemplateUtil.castOrThrow(object, DataMap.class)));
    }
        ...
        extends PathSpec
    {
        ...
        public com.linkedin.common.InputField.Fields items() {
            return new com.linkedin.common.InputField.Fields(getPathComponents(), PathSpec.WILDCARD);
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.common.InputField.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public InputFieldArray.ProjectionMask withItems(Function<com.linkedin.common.InputField.ProjectionMask, com.linkedin.common.InputField.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?InputField.createMask():_itemsMask));
