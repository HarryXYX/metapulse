    ...
    extends WrappingArrayTemplate<FormVerificationAssociation>
{
    ...
    public static FormVerificationAssociationArray.ProjectionMask createMask() {
        return new FormVerificationAssociationArray.ProjectionMask();
    }

    @Override
    public FormVerificationAssociationArray clone()
    ...
    @Override
    public FormVerificationAssociationArray copy()
        throws CloneNotSupportedException
    {
    ...
    @Override
    protected FormVerificationAssociation coerceOutput(Object object)
        ...
        extends PathSpec
    {
        ...
        public com.linkedin.common.FormVerificationAssociation.Fields items() {
            return new com.linkedin.common.FormVerificationAssociation.Fields(getPathComponents(), PathSpec.WILDCARD);
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.common.FormVerificationAssociation.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public FormVerificationAssociationArray.ProjectionMask withItems(Function<com.linkedin.common.FormVerificationAssociation.ProjectionMask, com.linkedin.common.FormVerificationAssociation.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?FormVerificationAssociation.createMask():_itemsMask));
