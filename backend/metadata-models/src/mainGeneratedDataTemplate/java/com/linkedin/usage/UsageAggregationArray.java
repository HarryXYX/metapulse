...
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/usage/UsageQueryResult.pdl.")
    ...
    extends WrappingArrayTemplate<UsageAggregation>
{
    ...
    public static UsageAggregationArray.ProjectionMask createMask() {
        return new UsageAggregationArray.ProjectionMask();
    }
    ...
    @Override
    protected UsageAggregation coerceOutput(Object object)
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.usage.UsageAggregation.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public UsageAggregationArray.ProjectionMask withItems(Function<com.linkedin.usage.UsageAggregation.ProjectionMask, com.linkedin.usage.UsageAggregation.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?UsageAggregation.createMask():_itemsMask));
