 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/metadata/snapshot/DataJobSnapshot.pdl.")
    ...
    extends RecordTemplate
{
    ...
    private com.linkedin.common.urn.DataJobUrn _urnField = null;
    private DataJobAspectArray _aspectsField = null;
    private DataJobSnapshot.ChangeListener __changeListener = new DataJobSnapshot.ChangeListener(this);
    ...
    public static DataJobSnapshot.ProjectionMask createMask() {
        return new DataJobSnapshot.ProjectionMask();
    }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_urnField!= null) {
                    ...
                    _urnField = DataTemplateUtil.coerceCustomOutput(__rawValue, com.linkedin.common.urn.DataJobUrn.class);
                    return _urnField;
                }
        }
    ...
    public DataJobSnapshot setUrn(
        @Nullable
        com.linkedin.common.urn.DataJobUrn value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setUrn(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field urn of com.linkedin.metadata.snapshot.DataJobSnapshot");
                } else {
                    CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.DataJobUrn.class));
                    _urnField = value;
                }
                break;
            case REMOVE_IF_NULL:
    ...
    public DataJobSnapshot setUrn(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field urn of com.linkedin.metadata.snapshot.DataJobSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.DataJobUrn.class));
            _urnField = value;
        }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_aspectsField!= null) {
                    ...
                    _aspectsField = ((__rawValue == null)?null:new DataJobAspectArray(DataTemplateUtil.castOrThrow(__rawValue, DataList.class)));
                    return _aspectsField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
    ...
    public DataJobSnapshot setAspects(
        @Nullable
        DataJobAspectArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setAspects(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field aspects of com.linkedin.metadata.snapshot.DataJobSnapshot");
                } else {
    ...
    public DataJobSnapshot setAspects(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field aspects of com.linkedin.metadata.snapshot.DataJobSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "aspects", value.data());
            _aspectsField = value;
        }
    ...
    {
        DataJobSnapshot __clone = ((DataJobSnapshot) super.clone());
        __clone.__changeListener = new DataJobSnapshot.ChangeListener(__clone);
    ...
    public DataJobSnapshot copy()
        throws CloneNotSupportedException
    {
        DataJobSnapshot __copy = ((DataJobSnapshot) super.copy());
        __copy._urnField = null;
        __copy._aspectsField = null;
        __copy.__changeListener = new DataJobSnapshot.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final DataJobSnapshot __objectRef;

        private ChangeListener(DataJobSnapshot reference) {
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.DataJobAspectArray.ProjectionMask _aspectsMask;
         ...
         * 
         */
        public DataJobSnapshot.ProjectionMask withUrn() {
         ...
         * 
         */
        public DataJobSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.DataJobAspectArray.ProjectionMask, com.linkedin.metadata.aspect.DataJobAspectArray.ProjectionMask> nestedMask) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?DataJobAspectArray.createMask():_aspectsMask));
         ...
         * 
         */
        public DataJobSnapshot.ProjectionMask withAspects() {
            _aspectsMask = null;
         ...
         * 
         */
        public DataJobSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.DataJobAspectArray.ProjectionMask, com.linkedin.metadata.aspect.DataJobAspectArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?DataJobAspectArray.createMask():_aspectsMask));
            getDataMap().put("aspects", _aspectsMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public DataJobSnapshot.ProjectionMask withAspects(Integer start, Integer count) {
            _aspectsMask = null;
