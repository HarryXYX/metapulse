 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/metadata/browse/BrowseResult.pdl.")
    ...
    extends RecordTemplate
{
    ...
    public BrowseResultGroup setName(
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field name of com.linkedin.metadata.browse.BrowseResultGroup");
                } else {
    ...
    public BrowseResultGroup setName(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field name of com.linkedin.metadata.browse.BrowseResultGroup to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "name", value);
            _nameField = value;
        }
    ...
    public BrowseResultGroup setCount(
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field count of com.linkedin.metadata.browse.BrowseResultGroup");
                } else {
    ...
    public BrowseResultGroup setCount(
        ...
        Long value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field count of com.linkedin.metadata.browse.BrowseResultGroup to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "count", DataTemplateUtil.coerceLongInput(value));
            _countField = value;
        }
