    ...
    extends RecordTemplate
{
    ...
    public static MLFeatureSnapshot.ProjectionMask createMask() {
        return new MLFeatureSnapshot.ProjectionMask();
    }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_urnField!= null) {
                    ...
                    _urnField = DataTemplateUtil.coerceCustomOutput(__rawValue, com.linkedin.common.urn.MLFeatureUrn.class);
                    return _urnField;
                }
        }
    ...
    public MLFeatureSnapshot setUrn(
        @Nullable
        com.linkedin.common.urn.MLFeatureUrn value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setUrn(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field urn of com.linkedin.metadata.snapshot.MLFeatureSnapshot");
                } else {
                    CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.MLFeatureUrn.class));
                    _urnField = value;
                }
                break;
            case REMOVE_IF_NULL:
    ...
    public MLFeatureSnapshot setUrn(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field urn of com.linkedin.metadata.snapshot.MLFeatureSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.MLFeatureUrn.class));
            _urnField = value;
        }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_aspectsField!= null) {
                    ...
                    _aspectsField = ((__rawValue == null)?null:new MLFeatureAspectArray(DataTemplateUtil.castOrThrow(__rawValue, DataList.class)));
                    return _aspectsField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
    ...
    public MLFeatureSnapshot setAspects(
        @Nullable
        MLFeatureAspectArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setAspects(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field aspects of com.linkedin.metadata.snapshot.MLFeatureSnapshot");
                } else {
    ...
    public MLFeatureSnapshot setAspects(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field aspects of com.linkedin.metadata.snapshot.MLFeatureSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "aspects", value.data());
            _aspectsField = value;
        }
    ...
    {
        MLFeatureSnapshot __clone = ((MLFeatureSnapshot) super.clone());
        __clone.__changeListener = new MLFeatureSnapshot.ChangeListener(__clone);
    ...
    public MLFeatureSnapshot copy()
        throws CloneNotSupportedException
    {
        MLFeatureSnapshot __copy = ((MLFeatureSnapshot) super.copy());
        __copy._urnField = null;
        __copy._aspectsField = null;
        __copy.__changeListener = new MLFeatureSnapshot.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final MLFeatureSnapshot __objectRef;

        private ChangeListener(MLFeatureSnapshot reference) {
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.MLFeatureAspectArray.ProjectionMask _aspectsMask;
         ...
         * 
         */
        public MLFeatureSnapshot.ProjectionMask withUrn() {
         ...
         * 
         */
        public MLFeatureSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.MLFeatureAspectArray.ProjectionMask, com.linkedin.metadata.aspect.MLFeatureAspectArray.ProjectionMask> nestedMask) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?MLFeatureAspectArray.createMask():_aspectsMask));
         ...
         * 
         */
        public MLFeatureSnapshot.ProjectionMask withAspects() {
            _aspectsMask = null;
         ...
         * 
         */
        public MLFeatureSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.MLFeatureAspectArray.ProjectionMask, com.linkedin.metadata.aspect.MLFeatureAspectArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?MLFeatureAspectArray.createMask():_aspectsMask));
            getDataMap().put("aspects", _aspectsMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public MLFeatureSnapshot.ProjectionMask withAspects(Integer start, Integer count) {
            _aspectsMask = null;
