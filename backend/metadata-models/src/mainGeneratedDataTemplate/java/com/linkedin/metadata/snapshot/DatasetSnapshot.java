    ...
    extends RecordTemplate
{
    ...
    public static DatasetSnapshot.ProjectionMask createMask() {
        return new DatasetSnapshot.ProjectionMask();
    }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_urnField!= null) {
                    ...
                    _urnField = DataTemplateUtil.coerceCustomOutput(__rawValue, com.linkedin.common.urn.DatasetUrn.class);
                    return _urnField;
                }
        }
    ...
    public DatasetSnapshot setUrn(
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field urn of com.linkedin.metadata.snapshot.DatasetSnapshot");
                } else {
                    CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.DatasetUrn.class));
                    _urnField = value;
                }
                break;
            case REMOVE_IF_NULL:
    ...
    public DatasetSnapshot setUrn(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field urn of com.linkedin.metadata.snapshot.DatasetSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.DatasetUrn.class));
            _urnField = value;
        }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_aspectsField!= null) {
                    ...
                    _aspectsField = ((__rawValue == null)?null:new DatasetAspectArray(DataTemplateUtil.castOrThrow(__rawValue, DataList.class)));
                    return _aspectsField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
    ...
    public DatasetSnapshot setAspects(
        @Nullable
        DatasetAspectArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setAspects(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field aspects of com.linkedin.metadata.snapshot.DatasetSnapshot");
                } else {
    ...
    public DatasetSnapshot setAspects(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field aspects of com.linkedin.metadata.snapshot.DatasetSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "aspects", value.data());
            _aspectsField = value;
        }
    ...
    {
        DatasetSnapshot __clone = ((DatasetSnapshot) super.clone());
        __clone.__changeListener = new DatasetSnapshot.ChangeListener(__clone);
    ...
    public DatasetSnapshot copy()
        throws CloneNotSupportedException
    {
        DatasetSnapshot __copy = ((DatasetSnapshot) super.copy());
        __copy._urnField = null;
        __copy._aspectsField = null;
        __copy.__changeListener = new DatasetSnapshot.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final DatasetSnapshot __objectRef;

        private ChangeListener(DatasetSnapshot reference) {
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.DatasetAspectArray.ProjectionMask _aspectsMask;
         ...
         * 
         */
        public DatasetSnapshot.ProjectionMask withUrn() {
         ...
         * 
         */
        public DatasetSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.DatasetAspectArray.ProjectionMask, com.linkedin.metadata.aspect.DatasetAspectArray.ProjectionMask> nestedMask) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?DatasetAspectArray.createMask():_aspectsMask));
         ...
         * 
         */
        public DatasetSnapshot.ProjectionMask withAspects() {
            _aspectsMask = null;
         ...
         * 
         */
        public DatasetSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.DatasetAspectArray.ProjectionMask, com.linkedin.metadata.aspect.DatasetAspectArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?DatasetAspectArray.createMask():_aspectsMask));
            getDataMap().put("aspects", _aspectsMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public DatasetSnapshot.ProjectionMask withAspects(Integer start, Integer count) {
            _aspectsMask = null;
