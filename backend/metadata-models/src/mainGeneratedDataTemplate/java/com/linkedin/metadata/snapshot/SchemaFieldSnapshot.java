    ...
    extends RecordTemplate
{
    ...
    private SchemaFieldSnapshot.ChangeListener __changeListener = new SchemaFieldSnapshot.ChangeListener(this);
    ...
    public static SchemaFieldSnapshot.ProjectionMask createMask() {
        return new SchemaFieldSnapshot.ProjectionMask();
    }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_aspectsField!= null) {
                    ...
                    _aspectsField = ((__rawValue == null)?null:new SchemaFieldAspectArray(DataTemplateUtil.castOrThrow(__rawValue, DataList.class)));
                    return _aspectsField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
    ...
    public SchemaFieldSnapshot setAspects(
        @Nullable
        SchemaFieldAspectArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
        ...
        throws CloneNotSupportedException
    {
        ...
        __clone.__changeListener = new SchemaFieldSnapshot.ChangeListener(__clone);
        ...
        throws CloneNotSupportedException
    {
        ...
        __copy.__changeListener = new SchemaFieldSnapshot.ChangeListener(__copy);
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.SchemaFieldAspectArray.ProjectionMask _aspectsMask;
         ...
         * 
         */
        public SchemaFieldSnapshot.ProjectionMask withUrn() {
         ...
         * 
         */
        public SchemaFieldSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.SchemaFieldAspectArray.ProjectionMask, com.linkedin.metadata.aspect.SchemaFieldAspectArray.ProjectionMask> nestedMask) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?SchemaFieldAspectArray.createMask():_aspectsMask));
         ...
         * 
         */
        public SchemaFieldSnapshot.ProjectionMask withAspects() {
            _aspectsMask = null;
         ...
         * 
         */
        public SchemaFieldSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.SchemaFieldAspectArray.ProjectionMask, com.linkedin.metadata.aspect.SchemaFieldAspectArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?SchemaFieldAspectArray.createMask():_aspectsMask));
            getDataMap().put("aspects", _aspectsMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public SchemaFieldSnapshot.ProjectionMask withAspects(Integer start, Integer count) {
            _aspectsMask = null;
