    ...
    extends WrappingArrayTemplate<MLModelDeploymentAspect>
{
    ...
    public static MLModelDeploymentAspectArray.ProjectionMask createMask() {
        return new MLModelDeploymentAspectArray.ProjectionMask();
    }

    @Override
    public MLModelDeploymentAspectArray clone()
        throws CloneNotSupportedException
    {
        MLModelDeploymentAspectArray __clone = ((MLModelDeploymentAspectArray) super.clone());
        return __clone;
    }

    @Override
    public MLModelDeploymentAspectArray copy()
        throws CloneNotSupportedException
    {
        MLModelDeploymentAspectArray __copy = ((MLModelDeploymentAspectArray) super.copy());
        return __copy;
    }

    @Override
    protected MLModelDeploymentAspect coerceOutput(Object object)
        throws TemplateOutputCastException
    {
        assert(object != null);
        return ((object == null)?null:new MLModelDeploymentAspect(object));
    }
        ...
        extends PathSpec
    {
        ...
        public com.linkedin.metadata.aspect.MLModelDeploymentAspect.Fields items() {
            return new com.linkedin.metadata.aspect.MLModelDeploymentAspect.Fields(getPathComponents(), PathSpec.WILDCARD);
        }
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.MLModelDeploymentAspect.ProjectionMask _itemsMask;

        ProjectionMask() {
            super(4);
        }

        public MLModelDeploymentAspectArray.ProjectionMask withItems(Function<com.linkedin.metadata.aspect.MLModelDeploymentAspect.ProjectionMask, com.linkedin.metadata.aspect.MLModelDeploymentAspect.ProjectionMask> nestedMask) {
            _itemsMask = nestedMask.apply(((_itemsMask == null)?MLModelDeploymentAspect.createMask():_itemsMask));
