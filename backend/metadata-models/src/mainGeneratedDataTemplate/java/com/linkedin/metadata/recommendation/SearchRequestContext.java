 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/metadata/recommendation/SearchRequestContext.pdl.")
    ...
    extends RecordTemplate
{
    ...
    private SearchRequestContext.ChangeListener __changeListener = new SearchRequestContext.ChangeListener(this);
    ...
    public static SearchRequestContext.ProjectionMask createMask() {
        return new SearchRequestContext.ProjectionMask();
    }
    ...
    {
        SearchRequestContext __clone = ((SearchRequestContext) super.clone());
        __clone.__changeListener = new SearchRequestContext.ChangeListener(__clone);
    ...
    public SearchRequestContext copy()
        throws CloneNotSupportedException
    {
        SearchRequestContext __copy = ((SearchRequestContext) super.copy());
        __copy._queryField = null;
        __copy._filtersField = null;
        __copy.__changeListener = new SearchRequestContext.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private ChangeListener(SearchRequestContext reference) {
        ...
        extends MaskMap
    {
         ...
         * 
         */
        public SearchRequestContext.ProjectionMask withQuery() {
         ...
         * 
         */
        public SearchRequestContext.ProjectionMask withFilters(Function<com.linkedin.metadata.query.filter.CriterionArray.ProjectionMask, com.linkedin.metadata.query.filter.CriterionArray.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public SearchRequestContext.ProjectionMask withFilters() {
            _filtersMask = null;
         ...
         * 
         */
        public SearchRequestContext.ProjectionMask withFilters(Function<com.linkedin.metadata.query.filter.CriterionArray.ProjectionMask, com.linkedin.metadata.query.filter.CriterionArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _filtersMask = nestedMask.apply(((_filtersMask == null)?CriterionArray.createMask():_filtersMask));
            getDataMap().put("filters", _filtersMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public SearchRequestContext.ProjectionMask withFilters(Integer start, Integer count) {
            _filtersMask = null;
