    ...
    extends RecordTemplate
{
    ...
    public static GlossaryTermSnapshot.ProjectionMask createMask() {
        return new GlossaryTermSnapshot.ProjectionMask();
    }
    ...
    public GlossaryTermSnapshot setUrn(
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field urn of com.linkedin.metadata.snapshot.GlossaryTermSnapshot");
                } else {
    ...
    public GlossaryTermSnapshot setUrn(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field urn of com.linkedin.metadata.snapshot.GlossaryTermSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "urn", DataTemplateUtil.coerceCustomInput(value, com.linkedin.common.urn.GlossaryTermUrn.class));
            _urnField = value;
        }
        ...
        switch (mode) {
            ...
            case NULL:
                if (_aspectsField!= null) {
                    ...
                    _aspectsField = ((__rawValue == null)?null:new GlossaryTermAspectArray(DataTemplateUtil.castOrThrow(__rawValue, DataList.class)));
                    return _aspectsField;
                }
        }
        throw new IllegalStateException(("Unknown mode "+ mode));
    ...
    public GlossaryTermSnapshot setAspects(
        @Nullable
        GlossaryTermAspectArray value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setAspects(value);
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field aspects of com.linkedin.metadata.snapshot.GlossaryTermSnapshot");
                } else {
    ...
    public GlossaryTermSnapshot setAspects(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field aspects of com.linkedin.metadata.snapshot.GlossaryTermSnapshot to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "aspects", value.data());
            _aspectsField = value;
        }
    ...
    {
        GlossaryTermSnapshot __clone = ((GlossaryTermSnapshot) super.clone());
        __clone.__changeListener = new GlossaryTermSnapshot.ChangeListener(__clone);
    ...
    public GlossaryTermSnapshot copy()
        throws CloneNotSupportedException
    {
        GlossaryTermSnapshot __copy = ((GlossaryTermSnapshot) super.copy());
        __copy._urnField = null;
        __copy._aspectsField = null;
        __copy.__changeListener = new GlossaryTermSnapshot.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final GlossaryTermSnapshot __objectRef;

        private ChangeListener(GlossaryTermSnapshot reference) {
        ...
        extends MaskMap
    {
        ...
        private com.linkedin.metadata.aspect.GlossaryTermAspectArray.ProjectionMask _aspectsMask;
         ...
         * 
         */
        public GlossaryTermSnapshot.ProjectionMask withUrn() {
         ...
         * 
         */
        public GlossaryTermSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.GlossaryTermAspectArray.ProjectionMask, com.linkedin.metadata.aspect.GlossaryTermAspectArray.ProjectionMask> nestedMask) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?GlossaryTermAspectArray.createMask():_aspectsMask));
         ...
         * 
         */
        public GlossaryTermSnapshot.ProjectionMask withAspects() {
            _aspectsMask = null;
         ...
         * 
         */
        public GlossaryTermSnapshot.ProjectionMask withAspects(Function<com.linkedin.metadata.aspect.GlossaryTermAspectArray.ProjectionMask, com.linkedin.metadata.aspect.GlossaryTermAspectArray.ProjectionMask> nestedMask, Integer start, Integer count) {
            _aspectsMask = nestedMask.apply(((_aspectsMask == null)?GlossaryTermAspectArray.createMask():_aspectsMask));
            getDataMap().put("aspects", _aspectsMask.getDataMap());
            if (start!= null) {
         ...
         * 
         */
        public GlossaryTermSnapshot.ProjectionMask withAspects(Integer start, Integer count) {
            _aspectsMask = null;
