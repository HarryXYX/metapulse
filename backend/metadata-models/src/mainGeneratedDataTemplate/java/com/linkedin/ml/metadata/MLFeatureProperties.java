 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-models/src/main/pegasus/com/linkedin/ml/metadata/MLFeatureProperties.pdl.")
    ...
    extends RecordTemplate
{
    ...
    private MLFeatureProperties.ChangeListener __changeListener = new MLFeatureProperties.ChangeListener(this);
    ...
    public static MLFeatureProperties.ProjectionMask createMask() {
        return new MLFeatureProperties.ProjectionMask();
    }
     ...
     * 
     * @see MLFeatureProperties.Fields#customProperties
     */
     ...
     * @see MLFeatureProperties.Fields#customProperties
     */
    public MLFeatureProperties setCustomProperties(
        @Nullable
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field customProperties of com.linkedin.ml.metadata.MLFeatureProperties");
                } else {
    ...
    public MLFeatureProperties setCustomProperties(
        ...
        StringMap value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field customProperties of com.linkedin.ml.metadata.MLFeatureProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "customProperties", value.data());
            _customPropertiesField = value;
        }
    ...
    public MLFeatureProperties setDescription(
        ...
        String value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field description of com.linkedin.ml.metadata.MLFeatureProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "description", value);
            _descriptionField = value;
        }
    ...
    public MLFeatureProperties setDataType(
        ...
        if (value == null) {
            throw new NullPointerException("Cannot set field dataType of com.linkedin.ml.metadata.MLFeatureProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "dataType", value.name());
            _dataTypeField = value;
        }
    ...
    public MLFeatureProperties setVersion(
        ...
        VersionTag value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field version of com.linkedin.ml.metadata.MLFeatureProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "version", value.data());
            _versionField = value;
        }
    ...
    public MLFeatureProperties setSources(
        ...
        UrnArray value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field sources of com.linkedin.ml.metadata.MLFeatureProperties to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "sources", value.data());
            _sourcesField = value;
        }
    ...
    {
        MLFeatureProperties __clone = ((MLFeatureProperties) super.clone());
        __clone.__changeListener = new MLFeatureProperties.ChangeListener(__clone);
    ...
    public MLFeatureProperties copy()
        throws CloneNotSupportedException
    {
        MLFeatureProperties __copy = ((MLFeatureProperties) super.copy());
        __copy._customPropertiesField = null;
        __copy._sourcesField = null;
        __copy._dataTypeField = null;
        __copy._descriptionField = null;
        __copy._versionField = null;
        __copy.__changeListener = new MLFeatureProperties.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final MLFeatureProperties __objectRef;

        private ChangeListener(MLFeatureProperties reference) {
        ...
        extends MaskMap
    {
         ...
         * 
         */
        public MLFeatureProperties.ProjectionMask withCustomProperties() {
         ...
         * 
         */
        public MLFeatureProperties.ProjectionMask withDescription() {
         ...
         * 
         */
        public MLFeatureProperties.ProjectionMask withDataType() {
         ...
         * 
         */
        public MLFeatureProperties.ProjectionMask withVersion(Function<com.linkedin.common.VersionTag.ProjectionMask, com.linkedin.common.VersionTag.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public MLFeatureProperties.ProjectionMask withVersion() {
            _versionMask = null;
         ...
         * 
         */
        public MLFeatureProperties.ProjectionMask withSources() {
         ...
         * 
         */
        public MLFeatureProperties.ProjectionMask withSources(Integer start, Integer count) {
