 ...
 */
public class DashboardStatsSummary implements java.io.Serializable {
    ...
    public DashboardStatsSummary() {
    }

    public DashboardStatsSummary(Integer viewCount, Integer viewCountLast30Days, Integer uniqueUserCountLast30Days, java.util.List<CorpUser> topUsersLast30Days) {
    ...
    public static DashboardStatsSummary.Builder builder() {
        return new DashboardStatsSummary.Builder();
    }
    ...
    public static class Builder {
        ...
        public DashboardStatsSummary build() {
            return new DashboardStatsSummary(viewCount, viewCountLast30Days, uniqueUserCountLast30Days, topUsersLast30Days);
        }
