...
public class CorpUserInfo implements java.io.Serializable {
    ...
    public CorpUserInfo(boolean active, String displayName, String email, String title, CorpUser manager, Long departmentId, String departmentName, String firstName, String lastName, String fullName, String countryCode, java.util.List<CustomPropertiesEntry> customProperties) {
        this.active = active;
    ...
    public static class Builder {
        ...
        public CorpUserInfo build() {
            return new CorpUserInfo(active, displayName, email, title, manager, departmentId, departmentName, firstName, lastName, fullName, countryCode, customProperties);
        }
