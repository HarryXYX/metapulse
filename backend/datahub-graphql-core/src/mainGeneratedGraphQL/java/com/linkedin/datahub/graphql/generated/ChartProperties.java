...
public class ChartProperties implements java.io.Serializable {
    ...
    public ChartProperties(String name, String description, String externalUrl, ChartType type, AccessLevel access, java.util.List<CustomPropertiesEntry> customProperties, Long lastRefreshed, AuditStamp created, AuditStamp lastModified, AuditStamp deleted) {
        this.name = name;
