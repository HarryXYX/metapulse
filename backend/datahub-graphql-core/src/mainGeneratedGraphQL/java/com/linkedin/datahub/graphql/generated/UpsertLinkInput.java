 ...
 */
public class UpsertLinkInput implements java.io.Serializable {
    ...
    public UpsertLinkInput() {
    }

    public UpsertLinkInput(String linkUrl, String label, String resourceUrn, LinkSettingsInput settings) {
    ...
    public static UpsertLinkInput.Builder builder() {
        return new UpsertLinkInput.Builder();
    }
    ...
    public static class Builder {
        ...
        public UpsertLinkInput build() {
            return new UpsertLinkInput(linkUrl, label, resourceUrn, settings);
        }
