    ...
    extends RecordTemplate
{
    ...
    private ChangeAuditStamps.ChangeListener __changeListener = new ChangeAuditStamps.ChangeListener(this);
    ...
    public static ChangeAuditStamps.ProjectionMask createMask() {
        return new ChangeAuditStamps.ProjectionMask();
    }
    ...
    public ChangeAuditStamps setCreated(
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field created of com.linkedin.common.ChangeAuditStamps");
                } else {
    ...
    public ChangeAuditStamps setCreated(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field created of com.linkedin.common.ChangeAuditStamps to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "created", value.data());
            _createdField = value;
        }
    ...
    public ChangeAuditStamps setLastModified(
        ...
        switch (mode) {
            ...
            case REMOVE_OPTIONAL_IF_NULL:
                if (value == null) {
                    throw new IllegalArgumentException("Cannot remove mandatory field lastModified of com.linkedin.common.ChangeAuditStamps");
                } else {
    ...
    public ChangeAuditStamps setLastModified(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field lastModified of com.linkedin.common.ChangeAuditStamps to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "lastModified", value.data());
            _lastModifiedField = value;
        }
    ...
    public ChangeAuditStamps setDeleted(
        ...
        AuditStamp value) {
        if (value == null) {
            throw new NullPointerException("Cannot set field deleted of com.linkedin.common.ChangeAuditStamps to null");
        } else {
            CheckedUtil.putWithoutChecking(super._map, "deleted", value.data());
            _deletedField = value;
        }
    ...
    {
        ChangeAuditStamps __clone = ((ChangeAuditStamps) super.clone());
        __clone.__changeListener = new ChangeAuditStamps.ChangeListener(__clone);
    ...
    public ChangeAuditStamps copy()
        throws CloneNotSupportedException
    {
        ChangeAuditStamps __copy = ((ChangeAuditStamps) super.copy());
        __copy._deletedField = null;
        __copy._createdField = null;
        __copy._lastModifiedField = null;
        __copy.__changeListener = new ChangeAuditStamps.ChangeListener(__copy);
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final ChangeAuditStamps __objectRef;

        private ChangeListener(ChangeAuditStamps reference) {
        ...
        extends MaskMap
    {
         ...
         * 
         */
        public ChangeAuditStamps.ProjectionMask withCreated(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public ChangeAuditStamps.ProjectionMask withCreated() {
            _createdMask = null;
         ...
         * 
         */
        public ChangeAuditStamps.ProjectionMask withLastModified(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public ChangeAuditStamps.ProjectionMask withLastModified() {
         ...
         * 
         */
        public ChangeAuditStamps.ProjectionMask withDeleted(Function<com.linkedin.common.AuditStamp.ProjectionMask, com.linkedin.common.AuditStamp.ProjectionMask> nestedMask) {
         ...
         * 
         */
        public ChangeAuditStamps.ProjectionMask withDeleted() {
            _deletedMask = null;
