 ...
 */
public class GlossaryTermInfo implements java.io.Serializable {
    ...
    public GlossaryTermInfo(String name, String description, String definition, String termSource, String sourceRef, String sourceUrl, java.util.List<CustomPropertiesEntry> customProperties, String rawSchema) {
        this.name = name;
    ...
    public static GlossaryTermInfo.Builder builder() {
        return new GlossaryTermInfo.Builder();
    }
    ...
    public static class Builder {
        ...
        public GlossaryTermInfo build() {
            return new GlossaryTermInfo(name, description, definition, termSource, sourceRef, sourceUrl, customProperties, rawSchema);
        }
