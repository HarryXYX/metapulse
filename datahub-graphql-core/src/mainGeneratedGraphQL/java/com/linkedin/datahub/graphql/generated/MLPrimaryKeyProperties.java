...
public class MLPrimaryKeyProperties implements java.io.Serializable {
    ...
    public MLPrimaryKeyProperties(String description, MLFeatureDataType dataType, VersionTag version, java.util.List<Dataset> sources, java.util.List<CustomPropertiesEntry> customProperties) {
    ...
    public static class Builder {
        ...
        public MLPrimaryKeyProperties build() {
            return new MLPrimaryKeyProperties(description, dataType, version, sources, customProperties);
        }
